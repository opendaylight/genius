...
public abstract  class NodeConnectorEvent<T extends DataObject> implements ClusteredDataTreeChangeListener<T>,AutoCloseable,NodeConnectorCommitter<T> {
    NodeConnectorEvent(Class<FlowCapableNodeConnector> flowCapableNodeConnectorClass) {
    }
