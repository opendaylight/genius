...
public class PMRegistrationListener {
    ...
    public PMRegistrationListener(){
        LOG.info("PMRegistrationListener Constructor called");
    }
    public void start() {
        LOG.info("PMRegistrationListener starting");
        queryMbeans();
