...
@Singleton
public class IdPoolListener extends AbstractSyncDataTreeChangeListener<IdPool> {
    ...
    public IdPoolListener(DataBroker dataBroker, IdManager idManager, IdUtils idUtils) {
        super(dataBroker, LogicalDatastoreType.CONFIGURATION,
              InstanceIdentifier.create(IdPools.class).child(IdPool.class));
    ...
    public void add(@Nonnull IdPool idPool) {
        LOG.info("Received add for name {} : {}", idPool.getPoolName());
    }
