...
public class IdManager implements IdManagerService, IdManagerMonitor {
    ...
    private IdLocalPool getOrCreateLocalIdPool(String parentPoolName, String localPoolName) throws IdManagerException, ReadFailedException {
        ...
        if (localIdPool == null) {
            ...
            try {
                ...
                IdPool childIdPool = singleTxDB.syncRead(LogicalDatastoreType.CONFIGURATION, childIdPoolInstanceIdentifier);
                if(childIdPool != null) {
