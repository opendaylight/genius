...
public class IdManager implements IdManagerService, IdManagerMonitor {
    ...
    private void releaseIdFromLocalPool(String parentPoolName, String localPoolName, String idKey) throws Exception {
        ...
        txRunner.callWithNewReadOnlyTransactionAndClose(Datastore.CONFIGURATION, tx -> {
            ...
            IdHolderSyncJob poolSyncJob = new IdHolderSyncJob(internedLocalPoolName, localIdPoolCache.getReleasedIds(),
                    txRunner, idUtils);
            ...
            UpdateIdEntryJob job = new UpdateIdEntryJob(parentPoolName, internedLocalPoolName, idKey, null, txRunner,
                    idUtils, lockManager);
            jobCoordinator.enqueueJob(parentPoolName, job, IdUtils.RETRY_COUNT);
        });
    }
