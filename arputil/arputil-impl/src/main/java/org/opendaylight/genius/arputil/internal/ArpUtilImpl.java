...
public class ArpUtilImpl implements OdlArputilService,
    ...
    private void fireArpRespRecvdNotification(String interfaceName, InetAddress inetAddr,
            byte[] macAddressBytes, int tableId, BigInteger metadata) throws InterruptedException {
