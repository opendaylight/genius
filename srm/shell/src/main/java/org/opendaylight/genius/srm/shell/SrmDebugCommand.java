...
public class SrmDebugCommand extends OsgiCommandSupport {
    ...
    final Logger LOG = LoggerFactory.getLogger(SrmDebugCommand.class);
    ...
    protected Object doExecute() throws Exception {
        if (dataBroker == null) {
            LOG.warn("DataBroker not initialized");
            return null;
        }
        if (clearOps) {
            clearOpsDs();
    ...
    private void clearOpsDs() {
        ...
        try {
            ...
            LOG.error("Error clearing ServiceOps DS. path:{}, data:{}", path);
        }
    }
