...
public final class ItmRpcTestImpl implements ItmRpcService {
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<Void>> buildExternalTunnelFromDpns(BuildExternalTunnelFromDpnsInput input) {
        return RpcResultBuilder.<Void>success().buildFuture();
    }

    @Override
    public synchronized ListenableFuture<RpcResult<Void>> removeExternalTunnelEndpoint(RemoveExternalTunnelEndpointInput input) {
        return RpcResultBuilder.<Void>success().buildFuture();
    }
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<Void>> removeExternalTunnelFromDpns(RemoveExternalTunnelFromDpnsInput input) {
        return RpcResultBuilder.<Void>success().buildFuture();
    }
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<GetExternalTunnelInterfaceNameOutput>> getExternalTunnelInterfaceName(
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<GetDpnEndpointIpsOutput>> getDpnEndpointIps(GetDpnEndpointIpsInput input) {
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<GetInternalOrExternalInterfaceNameOutput>> getInternalOrExternalInterfaceName(
    ...
    @Override
    public synchronized ListenableFuture<RpcResult<Void>> addExternalTunnelEndpoint(AddExternalTunnelEndpointInput input) {
        return RpcResultBuilder.<Void>success().buildFuture();
    }
