...
public interface FlowCapableNodeConnectorCommitter<D extends DataObject>
     ...
     * @param nodeConnIdent
     *            NodeConnector InstanceIdentifier
     */
    void remove(InstanceIdentifier<D> identifier, D del, InstanceIdentifier<FlowCapableNodeConnector> nodeConnIdent);

    /**
     * Method updates the original DataObject to the update DataObject in
     * device. Both are identified by same InstanceIdentifier
     *
     * @param identifier
     *            - the whole path to DataObject
     * @param original
     ...
     *            NodeConnector InstanceIdentifier
     */
    void add(InstanceIdentifier<D> identifier, D add, InstanceIdentifier<FlowCapableNodeConnector> nodeConnIdent);
