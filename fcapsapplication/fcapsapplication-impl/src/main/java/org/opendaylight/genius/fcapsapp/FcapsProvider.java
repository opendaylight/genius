...
public class FcapsProvider implements AutoCloseable {
    ...
    public FcapsProvider(DataBroker dataBroker,
                         ...
                         FlowNodeConnectorInventoryTranslatorImpl flowNodeConnectorInventoryTranslatorImpl,
        ...
        nodeEventListener = new NodeEventListener<>(this.entityOwnershipService);
        this.flowNodeConnectorInventoryTranslatorImpl = flowNodeConnectorInventoryTranslatorImpl;
