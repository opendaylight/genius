...
public class PacketInCounterHandler implements PacketProcessingListener {
    ...
    public void onPacketReceived(PacketReceived notification) {
        ...
        String counterKey = FcapsUtil.getCounterName(dpnId, FcapsConstants.COUNTERPACKETIN);
    ...
    public void nodeRemovedNotification(String dpnId) {
        if (dpnId != null) {
            ...
            if (counterMap.containsKey(FcapsUtil.getCounterName(dpnId,FcapsConstants.COUNTERPACKETIN))) {
                counterMap.get(FcapsUtil.getCounterName(dpnId,FcapsConstants.COUNTERPACKETIN)).close();
                counterMap.remove(FcapsUtil.getCounterName(dpnId,FcapsConstants.COUNTERPACKETIN));
            }
        } else {
