...
public interface ItmTestConstants {
    ...
    String INVALID_IP_ERROR_STR = "Invalid IpAddress. Expected: 1.0.0.0 to 254.255.255.255";
    String SUBNET_MASK_ERROR_STR = "Invalid Subnet Mask. Expected: 0.0.0.0/0 to 255.255.255.255/32";
    String MISMATCH_IPWITH_SUBNET_ERROR_STR = "IpAddress and gateWayIp should belong to the subnet provided";
