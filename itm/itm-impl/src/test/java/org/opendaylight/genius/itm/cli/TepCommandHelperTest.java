...
public class TepCommandHelperTest {
    ...
    private final InstanceIdentifier<TransportZone> transportZoneIdentifier = InstanceIdentifier.builder(TransportZones.class)
    ...
    private void setupMocks() {
        ...
        doReturn(FluentFuture.from(Futures.immediateCheckedFuture(new CommitInfo() {
        }))).when(mockWriteTx).commit();
    }
