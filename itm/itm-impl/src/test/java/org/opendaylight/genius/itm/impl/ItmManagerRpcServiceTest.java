...
public class ItmManagerRpcServiceTest {
    ...
    public void setUp() {
        ...
        itmManagerRpcService = new ItmManagerRpcService(dataBroker, mdsalApiManager, itmConfig,
                dpntePsInfoCache, interfaceManager, odlInterfaceRpcService,
                new DpnTepStateCache(dataBroker,
                        new GuavaCacheProvider(new CacheManagersRegistryImpl()), dpntePsInfoCache), directTunnelUtils);
    }
