...
import org.opendaylight.yang.gen.v1.urn.opendaylight.genius.idmanager.rev150403.*;
import org.opendaylight.yang.gen.v1.urn.opendaylight.genius.interfacemgr.rev150331.TunnelTypeBase;
import org.opendaylight.yang.gen.v1.urn.opendaylight.genius.interfacemgr.rev150331.TunnelTypeMplsOverGre;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.genius.itm.op.rev160406.external.tunnel.list
...
public class ItmManagerRpcServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        itmManagerRpcService = new ItmManagerRpcService(dataBroker,idManagerService);
        itmManagerRpcService.setMdsalManager(mdsalApiManager);
    }
    ...
    private void setupMocks(){
        ...
        tunnelEndPointsVxlan = new TunnelEndPointsBuilder().setVLANID(vlanId).setPortname(portName1).setIpAddress
                (ipAddress1).setGwIpAddress(gtwyIp1).setInterfaceName(tunnelInterfaceName).setTransportZone
