...
public class ItmTestUtil {
    ...
    public static void writeInterfaceConfig(InstanceIdentifier<Interface> ifIID, Interface extTunnelIf, DataBroker dataBroker) {
    ...
    public static void writeExternalTunnelConfig(InstanceIdentifier<ExternalTunnel> externalTunnelIdentifier, ExternalTunnel externalTunnel, DataBroker dataBroker) {
        WriteTransaction tx = dataBroker.newWriteOnlyTransaction();
