...
public class ItmTunnelAggregationTest {
    ...
    public void testBuild_all_tunnels_multipleVXLANtype() throws Exception {
        ...
        ITMBatchingUtils.registerWithBatchManager(dataBroker); //need to cause ietf-interface to be written
        ...
        InstanceIdentifier<Interface> logicTunnelId1 = ItmUtils.buildId(logicTunnelName1);
        Optional<Interface> optionalIface1 = dataBroker.newReadOnlyTransaction()
                .read(LogicalDatastoreType.CONFIGURATION, logicTunnelId1).checkedGet();
        assertTrue(optionalIface1.isPresent());
        ...
        InstanceIdentifier<Interface> logicTunnelId2 = ItmUtils.buildId(logicTunnelName2);
        Optional<Interface> optionalIface2 = dataBroker.newReadOnlyTransaction()
                .read(LogicalDatastoreType.CONFIGURATION, logicTunnelId2).checkedGet();
        assertTrue(optionalIface2.isPresent());
