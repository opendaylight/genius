...
public class ItmCliTest {
    ...
    public void testBuildLocalCacheWithInvalidIp() throws Exception{
        ...
        try {
            ...
            errorOutput = e.getMessage() + ItmTestConstants.NEW_LINE;
        }
        assertEquals(ItmTestConstants.INVALID_IP_ERROR_STR + ItmTestConstants.NEW_LINE,errorOutput);
    ...
    public void testBuildLocalCacheWithInvalidSubnetMask() throws Exception{
        ...
        assertEquals(ItmTestConstants.SUBNET_MASK_ERROR_STR + ItmTestConstants.NEW_LINE,errorOutput);
    ...
    public void testBuildLocalCacheWithMismatchIpwithSubnet() throws Exception{
        ...
        assertEquals(ItmTestConstants.MISMATCH_IPWITH_SUBNET_ERROR_STR + ItmTestConstants.NEW_LINE,errorOutput);
