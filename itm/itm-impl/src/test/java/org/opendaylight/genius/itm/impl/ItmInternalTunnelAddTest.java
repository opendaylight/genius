...
public class ItmInternalTunnelAddTest {
    ...
    public void testBuild_all_tunnels_VXLANtype() {
        ...
        addWorker.build_all_tunnels(dataBroker,idManagerService,mdsalApiManager,cfgdDpnListVxlan,meshDpnListVxlan, itmConfig);
    ...
    public void testBuild_all_tunnels_GREtype() {
        ...
        addWorker.build_all_tunnels(dataBroker,idManagerService,mdsalApiManager,cfgdDpnListGre,meshDpnListGre, itmConfig);
    ...
    public void testBuild_all_tunnels_Boyhtype() {
        ...
        addWorker.build_all_tunnels(dataBroker,idManagerService,mdsalApiManager,cfgdDpnListVxlan,meshDpnListGre, itmConfig);
