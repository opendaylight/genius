...
public class ItmInternalTunnelAddTest {
    ...
    public void setUp() {
        ...
        dpnEndPointsVxlanOptional = Optional.of(new DpnEndpointsBuilder().setDPNTEPsInfo(cfgdDpnListVxlan).build());
        dpnEndPointsGreOptional = Optional.of(new DpnEndpointsBuilder().setDPNTEPsInfo(cfgdDpnListGre).build());
    ...
    public void testBuild_all_tunnels_VXLANtype() {
        ...
        addWorker.build_all_tunnels(dataBroker, idManagerService, mdsalApiManager, cfgdDpnListVxlan, itmConfig);
    ...
    public void testBuild_all_tunnels_GREtype() {
        ...
        addWorker.build_all_tunnels(dataBroker, idManagerService, mdsalApiManager, cfgdDpnListGre, itmConfig);
