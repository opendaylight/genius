...
public class ItmTunnelAddDelTest {
    ...
    public void testBuildTunnelsFromDpnToExternalEndPoint() throws Exception{
        ...
        ItmTestUtil.writeInterfaceConfig(interfaceIdentifierForDpnToExtrEndPoint, ifaceForDpnToExtrEndPoint,  dataBroker);
        ...
        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier, externalTunnelForDpnToExtrEndPoint,  dataBroker);
        assertEqualBeans(ExpectedExternalTunnelObjects.newExternalTunnel(),  dataBroker.newReadOnlyTransaction().
                read(LogicalDatastoreType.CONFIGURATION,externalTunnelIdentifier).checkedGet().get());
    ...
    public void testBuildDeleteHwVtepsTunnels()throws Exception{
        ...
        ItmTestUtil.writeInterfaceConfig(ifIID1, extTunnelIf1,  dataBroker);
        ItmTestUtil.writeInterfaceConfig(ifIID2, hwTunnelIf2,  dataBroker);
        ItmTestUtil.writeInterfaceConfig(ifIID3, extTunnelIf3,  dataBroker);
        ItmTestUtil.writeInterfaceConfig(ifIID4, hwTunnelIf4,  dataBroker);
        ItmTestUtil.writeInterfaceConfig(ifIID5, hwTunnelIf5,  dataBroker);
        ItmTestUtil.writeInterfaceConfig(ifIID6, hwTunnelIf6,  dataBroker);

        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier1, externalTunnel1,  dataBroker);
        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier2, externalTunnel2,  dataBroker);
        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier3, externalTunnel3,  dataBroker);
        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier4, externalTunnel4,  dataBroker);
        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier5, externalTunnel5,  dataBroker);
        ItmTestUtil.writeExternalTunnelConfig(externalTunnelIdentifier6, externalTunnel6,  dataBroker);
