...
public class ItmTepAutoConfigTest {
    ...
    public void defTzEnabledFalseConfigTest() throws Exception {
        ...
        /*if (dataBroker != null)
        {
            String errMsg = "iid : " + txRunner.callWithNewWriteOnlyTransactionAndSubmit(CONFIGURATION, tx -> tx.put(iid, itmConfigObj, true));
            throw new NullPointerException(errMsg);
        }


        // write into config DS
        //txRunner.callWithNewWriteOnlyTransactionAndSubmit(CONFIGURATION, tx -> tx.merge(iid, itmConfigObj, true));

        txRunner.callWithNewWriteOnlyTransactionAndSubmit(tx -> tx.merge(LogicalDatastoreType.CONFIGURATION,
                        iid,itmConfigObj, WriteTransaction.CREATE_MISSING_PARENTS));
        ...
        boolean defTzEnabled =  dataBroker.newReadOnlyTransaction()
                .read(LogicalDatastoreType.CONFIGURATION, iid).get().get().isDefTzEnabled();
    ...
    public void defTzEnabledTrueConfigTest() throws Exception {
        ...
        txRunner.callWithNewWriteOnlyTransactionAndSubmit(tx -> tx.merge(LogicalDatastoreType.CONFIGURATION,
                iid,itmConfigObj, WriteTransaction.CREATE_MISSING_PARENTS)).get();
    ...
    public void defTzCreationTestWithDefTzEnabledTrueAndVxlanTunnelType() throws Exception {
        ...
        InstanceIdentifier<TransportZone> tzPath = ItmUtils.getTZInstanceIdentifier(ITMConstants.DEFAULT_TRANSPORT_ZONE);
        txRunner.callWithNewWriteOnlyTransactionAndSubmit(tx -> tx.merge(LogicalDatastoreType.CONFIGURATION,
    ...
    public void tepUpdateForTepIpTest() throws Exception {
        ...
        /*if (dataBroker != null)
        {
            String errMsg = "present db :" + dataBroker.newReadOnlyTransaction().read(LogicalDatastoreType.CONFIGURATION, defTzonePath);
            throw new NullPointerException(errMsg);
        }*/
    ...
    public void tepUpdateForBrNameTest() throws Exception {
        ...
        /*if (dataBroker != null)
        {
            String errMsg = "present db :" + dataBroker.newReadOnlyTransaction().read(LogicalDatastoreType.CONFIGURATION, tzonePath);
            throw new NullPointerException(errMsg);
        }*/
