...
public class ItmTepAutoConfigTest {
    ...
    @Test
    public void testAddDeleteTepForDefTzTest() throws Exception {
        // create default-TZ first by setting def-tz-enabled flag to true
        ItmConfig itmConfigObj = new ItmConfigBuilder().
            setDefTzEnabled(true).setDefTzTunnelType(ITMConstants.TUNNEL_TYPE_VXLAN).build();
        ...
        ItmTepAutoConfigTestUtil.deleteTep(ItmTestConstants.defTzTepIp, ItmTestConstants.strDefTzTepdpnId,
    ...
    @Test
    public void testAddDeleteTepForTzTest() throws Exception {
        // create TZ
        ...
        // remove tep
        ItmTepAutoConfigTestUtil.deleteTep(ItmTestConstants.tzTepIp, ItmTestConstants.strTzTepdpnId,
            ItmTestConstants.tzName, dataBroker);
