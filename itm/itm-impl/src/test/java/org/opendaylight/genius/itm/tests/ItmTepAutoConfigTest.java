...
public class ItmTepAutoConfigTest {
    ...
    public void defTzEnabledFalseConfigTest() throws Exception {
        ...
        // read from config DS
        Optional<ItmConfig> opItmConfig = ItmTepAutoConfigTestUtil.readItmConfig(iid, dataBroker);
        if (opItmConfig.isPresent()) {
            boolean defTzEnabled = opItmConfig.get().isDefTzEnabled();
