...
public class ItmTepAutoConfigTest {
    ...
    public void tepAddDeleteFromDefTzViaSouthboundTest() throws Exception  {
        ...
        futures = OvsdbTestUtil.addBridgeIntoNode(connInfo, ItmTestConstants.DEF_BR_NAME,
        ...
        tepIp = null;
        futures = OvsdbTestUtil.updateNode(connInfo, tepIp, ITMConstants.DEFAULT_TRANSPORT_ZONE,
            null, dataBroker);
        try {
            futures.get();
        } catch (InterruptedException | ExecutionException e) {
    ...
    public void tepAddDeleteFromNbTzViaSouthboundTest() throws Exception  {
        ...
        ConnectionInfo connInfo = OvsdbTestUtil.getConnectionInfo(ItmTestConstants.OVSDB_CONN_PORT,
            ItmTestConstants.LOCALHOST_IP);
        CheckedFuture<Void, TransactionCommitFailedException> futures = OvsdbTestUtil.createNode(
        ...
        // pass tep-ip with NULL value, tep-ip paramtere in external_ids will not be set.
        tepIp = null;
        futures = OvsdbTestUtil.updateNode(connInfo, tepIp, ItmTestConstants.TZ_NAME, null, dataBroker);
        try {
            futures.get();
        } catch (InterruptedException | ExecutionException e) {
            throw new RuntimeException(e.getMessage());
    ...
    public void tzAddDeleteToNotHostedViaSouthboundTest() throws Exception  {
        ...
        futures = OvsdbTestUtil.updateNode(connInfo, ItmTestConstants.NOT_HOSTED_TZ_TEP_IP, null,
    ...
    public void tepUpdateForDpnBrNameTest() throws Exception {
        ...
        // add new bridge br2
        futures = OvsdbTestUtil.addBridgeIntoNode(connInfo, ItmTestConstants.BR2_NAME,
        ...
        futures = OvsdbTestUtil.updateNode(connInfo, ItmTestConstants.NB_TZ_TEP_IP,
            ItmTestConstants.TZ_NAME, dpnBrName, dataBroker);
        try {
            futures.get();
        } catch (InterruptedException | ExecutionException e) {
            throw new RuntimeException(e.getMessage());
    ...
    public void tepDeleteFromTepsNotHostedListTest() throws Exception {
        ...
        futures = ItmTepAutoConfigTestUtil.deleteTep(ItmTestConstants.NOT_HOSTED_TZ_TEP_IP,
