...
public class ItmTunnelAggregationTestModule {

    public @Rule LogRule logRule = new LogRule();
    public @Rule MethodRule guice = new GuiceRule(new ItmTunnelAggregationConfigTest(),
    ...
    public void testBuild_all_tunnels_multipleVXLANtype() throws Exception {
        ...
        assertEquals(isTunnelAggregationEnabled, true);
