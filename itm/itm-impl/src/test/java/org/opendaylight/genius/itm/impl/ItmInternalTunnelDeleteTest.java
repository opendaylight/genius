...
public class ItmInternalTunnelDeleteTest {
    ...
    public void setUp() {
        ...
        itmInternalTunnelDeleteWorker = new ItmInternalTunnelDeleteWorker(dataBroker, jobCoordinator,
                ...
                interfaceManager,
                new DpnTepStateCache(dataBroker, jobCoordinator, new GuavaCacheProvider(
                        new CacheManagersRegistryImpl()), directTunnelUtils, dpntePsInfoCache, interfaceManager,
