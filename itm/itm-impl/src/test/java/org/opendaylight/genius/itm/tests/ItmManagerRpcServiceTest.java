...
public class ItmManagerRpcServiceTest {
    ...
    ExternalTunnel externalTunnel2 = null;
    ...
    GetInternalOrExternalInterfaceNameInput getExternalInterfaceNameInput = null;
    GetInternalOrExternalInterfaceNameInput getInternalInterfaceNameInput = null;
    GetInternalOrExternalInterfaceNameOutput getInternalOrExternalInterfaceNameOutput = null;
    ...
    public void testGetExternalInterfaceNameExtTunnelPresent() throws Exception {
        ...
        Assert.assertEquals(true, rpcRes.get().isSuccessful());

        Assert.assertEquals(getInternalOrExternalInterfaceNameOutput, rpcRes.get().getResult());
    }
    ...
    public void testAddExternalTunnelEndpoint() throws Exception {
        Future<RpcResult<Void>> result = itmManagerRpcService.addExternalTunnelEndpoint(addExternalTunnelEndpointInput);
        Thread.sleep(1000);
    ...
    public void testGetExternalTunnelInterfaceName() throws Exception {
        ...
        Assert.assertEquals(ItmTestConstants.parentInterfaceName, rpcRes.get().getResult().getInterfaceName());
    }
}
