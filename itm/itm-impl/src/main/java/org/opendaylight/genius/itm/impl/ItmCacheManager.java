...
public class ItmCacheManager {
    ...
    public void close() throws Exception {
        ...
        if (ipToDpnIdCache != null) {
            ipToDpnIdCache.close();
        }
        LOG.info("ItmProvider Closed");
    }

    public void addDpnIdAndIp(BigInteger dpnId, String ip) {
        dpnIdToIpCache.put(dpnId, ip);
        ipToDpnIdCache.put(ip, dpnId);
    }
}
