...
public final class ItmInternalTunnelAddWorker {
    ...
    private void createInternalDirectTunnels(TypedWriteTransaction<Configuration> tx, TunnelEndPoints srcte, TunnelEndPoints dstte,
    ...
    private List<ListenableFuture<Void>> addTunnelConfiguration(TypedWriteTransaction<Configuration> tx, Interface iface) throws ReadFailedException {
