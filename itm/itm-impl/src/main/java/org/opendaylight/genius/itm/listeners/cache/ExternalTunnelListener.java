...
public class ExternalTunnelListener extends
     ...
     */
    @Inject
    public ExternalTunnelListener(final DataBroker dataBroker, final ExternalTunnelCache externalTunnelCache) {
