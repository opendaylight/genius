...
public class TunnelTopologyStateListener
        extends AbstractClusteredSyncDataTreeChangeListener<OvsdbBridgeAugmentation> {
    ...
    private void runOnlyInOwnerNode(String jobDesc, Runnable job) {
        entityOwnershipUtils.runOnlyInOwnerNode(ITMConstants.ITM_CONFIG_ENTITY,
                ITMConstants.ITM_CONFIG_ENTITY, coordinator, jobDesc, job);
    }

    @Override
    public void remove(InstanceIdentifier<OvsdbBridgeAugmentation> identifier, OvsdbBridgeAugmentation bridgeOld) {
    ...
    @Override
    public void update(InstanceIdentifier<OvsdbBridgeAugmentation> identifier, OvsdbBridgeAugmentation bridgeOld,
    ...
    @Override
    public void add(InstanceIdentifier<OvsdbBridgeAugmentation> identifier, OvsdbBridgeAugmentation bridgeNew) {
    ...
    private class RendererStateAddWorker implements Callable<List<ListenableFuture<Void>>> {
        final InstanceIdentifier<OvsdbBridgeAugmentation> bridgeIid;
    ...
    private class RendererStateRemoveWorker implements Callable<List<ListenableFuture<Void>>> {
        final InstanceIdentifier<OvsdbBridgeAugmentation> instanceIdentifier;
        final OvsdbBridgeAugmentation bridgeNew;
    ...
    private class RendererStateUpdateWorker implements Callable<List<ListenableFuture<Void>>> {
        final InstanceIdentifier<OvsdbBridgeAugmentation> instanceIdentifier;
        final OvsdbBridgeAugmentation bridgeNew;
        final OvsdbBridgeAugmentation bridgeOld;
