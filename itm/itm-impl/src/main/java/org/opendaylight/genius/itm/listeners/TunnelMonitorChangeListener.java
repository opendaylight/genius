        ...
        if (transportZonesOptional.isPresent()) {
            ...
            for (TransportZone tzone : transportZones.getTransportZone()) {
                ...
                ItmMonitorToggleWorker toggleWorker = new ItmMonitorToggleWorker(tzone.getZoneName(),
                    false,monitorProtocol, broker, directTunnelUtils, dpnTepStateCache,
        ...
        if (transportZonesOptional.isPresent()) {
            ...
            for (TransportZone tzone : tzones.getTransportZone()) {
                ...
                ItmMonitorToggleWorker toggleWorker = new ItmMonitorToggleWorker(tzone.getZoneName(),
                    ...
                    dpnTepStateCache, interfaceManager, ovsBridgeRefEntryCache);
                jobCoordinator.enqueueJob(tzone.getZoneName(), toggleWorker);
            }
        }
    }
    ...
    public void add(@Nonnull InstanceIdentifier<TunnelMonitorParams> instanceIdentifier,
        ...
        if (transportZonesOptional.isPresent()) {
            ...
            for (TransportZone tzone : tzones.getTransportZone()) {
                ...
                ItmMonitorToggleWorker toggleWorker = new ItmMonitorToggleWorker(tzone.getZoneName(),
                    dataObjectModification.isEnabled(),monitorProtocol, broker, directTunnelUtils, dpnTepStateCache,
                    interfaceManager, ovsBridgeRefEntryCache);
                jobCoordinator.enqueueJob(tzone.getZoneName(), toggleWorker);
            }
        }
