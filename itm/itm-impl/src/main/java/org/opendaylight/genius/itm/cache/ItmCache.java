 ...
 */
public abstract class ItmCache<K extends Object, V extends Object> implements AutoCloseable {

    protected final Cache<K, V> cache;

    public ItmCache(CacheProvider cacheProvider, String cacheName, String description) {
