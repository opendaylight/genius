...
public class DpnTepStateCache extends DataObjectCache<BigInteger, DpnsTeps> {
    ...
    public DpnTepInterfaceInfo getTunnelFromConfigDS(TunnelEndPointInfo tunnelEndPointInfo) {
        DpnTepInterfaceInfo dpnTepInfo = null ;
        if (tunnelEndPointInfo != null) {
            dpnTepInfo = getDpnTepInterfaceInfo(tunnelEndPointInfo.getSrcEndPointInfo(),
