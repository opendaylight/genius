 ...
 */
public class TunnelInventoryStateListener extends TunnelListenerBase<FlowCapableNodeConnector> {
    ...
    private class InterfaceStateAddWorker implements Callable {
        ...
        public Object call() throws Exception {
            ...
            return addState(key, interfaceName, fcNodeConnectorNew, null, false);
        }
