...
public class OvsTunnelConfigRemoveHelper {
    ...
    private static void removeTunnelConfiguration(ParentRefs parentRefs,
        ...
        OvsdbBridgeRef ovsdbBridgeRef =
                TunnelMetaUtils.getOvsdbBridgeRef(dpId, dataBroker);
    ...
    public static void removeTunnelIngressFlow(List<ListenableFuture<Void>> futures,
        ...
        long portNo = ItmScaleUtils.getNodeConnectorIdFromInterface(interfaceName, dataBroker);
        DpnTepInterfaceInfo dpnTepInfo  = TunnelUtils.getTunnelFromConfigDS(interfaceName, dataBroker);

            TunnelUtils.makeTunnelIngressFlow(futures, mdsalApiManager,
                    dpnTepInfo,
    ...
    public static StateTunnelList cleanUpInterfaceWithUnknownState(String interfaceName, ParentRefs parentRefs,
