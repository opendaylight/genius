...
public class ItmManagerRpcService implements ItmRpcService {
    ...
    public ListenableFuture<RpcResult<SetBfdParamOnTunnelOutput>> setBfdParamOnTunnel(
        ...
        //DpnTepInterfaceInfo interfaceInfo = dpnTepStateCache.getDpnTepInterface(srcDpnId, destDpnId);

        if(monitoredTunnels.contains(srcDpnId) && monitoredTunnels.contains(destDpnId))
        {
