...
public class ItmTunnelAggregationHelper {
    ...
    private static Bucket createBucket(IfTunnel ifTunnel, ParentRefs parentRefs, Integer ifIndex, int bucketId, int portNumber) {
    ...
    private static void updateTunnelAggregationGroupBucket(Interface ifaceState, IfTunnel ifTunnel,
        ...
        if (action == ADD_TUNNEL) {
            ...
            logger.debug("MULTIPLE_VxLAN_TUNNELS: updateTunnelAggregationGroupBucket - add - groupId {} bucketId {}",
                    groupId, bucketId);
            mdsalManager.addBucketToTx(srcDpnId, groupId, buckt, tx);
        } else {
            logger.debug("MULTIPLE_VxLAN_TUNNELS: updateTunnelAggregationGroupBucket - remove - groupId {} bucketId {}",
                    groupId, bucketId);
    ...
    private static void updateInterfaceOperStatus(String logicGroupName, Interface ifaceLogicGroupState,
        ...
        logger.debug("MULTIPLE_VxLAN_TUNNELS: updateInterfaceOperStatus to {} for logical group {}", st.toString(), logicGroupName);
