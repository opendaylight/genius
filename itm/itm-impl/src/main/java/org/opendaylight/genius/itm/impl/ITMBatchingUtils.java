...
public class ITMBatchingUtils {
    ...
    public static void registerWithBatchManager(DataBroker dataBroker) {
        ...
        resBatchingManager.registerBatchableResource("ITM-DEFAULT-OPERATIONAL", defaultOperationalShardBufferQ, new ITMBatchHandler(LogicalDatastoreType.OPERATIONAL));
        resBatchingManager.registerBatchableResource("ITM-DEFAULT-CONFIG", defaultConfigShardBufferQ, new ITMBatchHandler(LogicalDatastoreType.CONFIGURATION));
    }
