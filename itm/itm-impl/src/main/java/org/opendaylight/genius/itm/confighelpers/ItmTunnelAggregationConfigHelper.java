...
public class ItmTunnelAggregationConfigHelper {
    ...
    @Inject
    public ItmTunnelAggregationConfigHelper(IdManagerService idManager, ItmConfig itmConfig) {
    ...
    private static void initTunnelAggregationConfig(ItmConfig itmConfig) {
        ...
        ItmTunnelAggregationConfigHelper.tunnelAggregationEnabled = tunnelAggregationConfigEnabled;
    }
