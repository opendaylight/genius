...
public class ItmExternalTunnelAddWorker {
        ...
        if (null != cfgDpnList) {
            for (DPNTEPsInfo teps : cfgDpnList) {
                ...
                Interface iface = ItmUtils.buildTunnelInterface(teps.getDPNID(), trunkInterfaceName,
                    ...
                    tunType, firstEndPt.getIpAddress(), extIp, false,
    ...
    private void tunnelsFromhWVtep(HwVtep hwTep, TypedReadWriteTransaction<Configuration> tx,
            Integer monitorInterval, Class<? extends TunnelMonitoringTypeBase> monitorProtocol) throws ExecutionException, InterruptedException{
    ...
    private boolean wireUp(BigInteger dpnId, IpAddress srcIp, Boolean remoteIpFlow,
            ...
            Class<? extends TunnelMonitoringTypeBase> monitorProtocol, TypedWriteTransaction<Configuration> tx) {
        IpAddress gatewayIpObj = IpAddressBuilder.getDefaultInstance("0.0.0.0");
        IpAddress gwyIpAddress = gatewayIpObj;
