...
public final class TunnelUtils {
    ...
    public static StateTunnelList getTunnelFromOperDS(String tunnelName, DataBroker dataBroker,
        ...
        try {
            Optional<StateTunnelList> stateTunnelList =
                    tunnelStateCache.get(getStateTunnelListIdentifier(new StateTunnelListKey(tunnelName)));
    ...
    public static Interface getInterfaceFromConfigDS(String tunnelName,
        ...
        if (endPointInfo != null) {
            ...
            dpnTepInfo = ItmScaleUtils.getDpnTepInterfaceFromCache(new BigInteger(endPointInfo.getSrcDpnId()),
                    new BigInteger(endPointInfo.getDstDpnId()));
            if (dpnTepInfo != null) {
                List<DPNTEPsInfo> srcDpnTEPsInfo = ItmUtils.getDPNTepListFromDPNId(dpntePsInfoCache,
                        new ArrayList<>(Arrays.asList(new BigInteger(endPointInfo.getSrcDpnId()))));
                List<DPNTEPsInfo> dstDpnTEPsInfo = ItmUtils.getDPNTepListFromDPNId(dpntePsInfoCache,
    ...
    public static StateTunnelList getTunnelFromOperationalDS(String tunnelName, DataBroker dataBroker,
        ...
        try {
            Optional<StateTunnelList> stateTunnelList = tunnelStateCache.get(getStateTunnelListIdentifier(new
                    StateTunnelListKey(tunnelName)));
            if (stateTunnelList.isPresent()) {
                return stateTunnelList.get();
            }
        } catch (ReadFailedException exception) {
    ...
    public static StateTunnelList addStateEntry(TunnelEndPointInfo tunnelEndPointInfo, String interfaceName,
        ...
        */
        ...
        DPNTEPsInfo srcDpnTepsInfo = ItmUtils.getDPNTepFromDPNId(dpntePsInfoCache, new BigInteger(tunnelEndPointInfo
                .getSrcDpnId()));
        ...
        DPNTEPsInfo dstDpnTePsInfo = ItmUtils.getDPNTepFromDPNId(dpntePsInfoCache, new BigInteger(tunnelEndPointInfo
                .getDstDpnId()));
