...
public final class TunnelMetaUtils {
    ...
    private TunnelMetaUtils() {
    }

    public static InstanceIdentifier<OvsBridgeRefEntry> getOvsBridgeRefEntryIdentifier(OvsBridgeRefEntryKey
                                                                                               bridgeRefEntryKey) {
        InstanceIdentifier.InstanceIdentifierBuilder<OvsBridgeRefEntry> bridgeRefEntryInstanceIdentifierBuilder =
                InstanceIdentifier.builder(OvsBridgeRefInfo.class).child(OvsBridgeRefEntry.class, bridgeRefEntryKey);
    ...
    static InstanceIdentifier<OvsBridgeTunnelEntry> getBridgeTunnelEntryIdentifier(OvsBridgeEntryKey bridgeEntryKey,
    ...
    public static OvsBridgeEntry getOvsBridgeEntryFromConfigDS(InstanceIdentifier<OvsBridgeEntry>
    ...
    private static OvsBridgeEntry readBridgeEntryFromConfigDS(InstanceIdentifier<OvsBridgeEntry>
                                                                      bridgeEntryInstanceIdentifier,
                                                              DataBroker dataBroker) {
    ...
    static void createLportTagInterfaceMap(WriteTransaction transaction, String infName, Integer ifIndex) {
    ...
    public static void removeLportTagInterfaceMap(IdManagerService idManager, WriteTransaction transaction,
                                                  String infName) {
    ...
    public static void addBridgeRefToBridgeTunnelEntry(BigInteger dpId, OvsdbBridgeRef ovsdbBridgeRef,
        ...
        transaction.merge(LogicalDatastoreType.CONFIGURATION, bridgeEntryInstanceIdentifier,
                bridgeEntryBuilder.build(), true);
    }
    ...
    public static void createOvsBridgeRefEntry(BigInteger dpnId, InstanceIdentifier<?> bridgeIid,
        ...
        transaction.put(LogicalDatastoreType.OPERATIONAL, bridgeEntryId, tunnelDpnBridgeEntryBuilder.build(), true);
    }

    public static void deleteOvsBridgeRefEntry(BigInteger dpnId, WriteTransaction transaction) {
        LOG.debug("Deleting bridge ref entry for dpn: {}", dpnId);
        OvsBridgeRefEntryKey bridgeRefEntryKey = new OvsBridgeRefEntryKey(dpnId);
        InstanceIdentifier<OvsBridgeRefEntry> bridgeEntryId =
                TunnelMetaUtils.getOvsBridgeRefEntryIdentifier(bridgeRefEntryKey);
        transaction.delete(LogicalDatastoreType.OPERATIONAL, bridgeEntryId);
    }

    public static void deleteBridgeInterfaceEntry(OvsBridgeEntryKey bridgeEntryKey,
