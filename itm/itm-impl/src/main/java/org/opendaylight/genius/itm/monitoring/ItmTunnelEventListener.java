...
public class ItmTunnelEventListener extends AbstractSyncDataTreeChangeListener<StateTunnelList> {
    ...
    @Override
    public void remove(@Nonnull StateTunnelList stateTunnelList) {
    ...
    @Override
    public void update(@Nonnull StateTunnelList originalTunnelList, @Nonnull StateTunnelList updatedTunnelList) {
    ...
    @Override
    public void add(@Nonnull StateTunnelList stateTunnelList) {
