...
public class ItmTzInstanceRecoveryHandler extends
        ...
        if (tz != null) {
            ...
            for (String tunnelInterface : tunnelList) {
                ...
                eventCallbacks.onRemove(LogicalDatastoreType.OPERATIONAL, stListId, (unused) -> {
                    ...
                    recreateTZ(entityId,tz,tzII,tunnelList.size());
                }, Duration.ofMillis(5000), (id) -> recreateTZ(entityId,tz,tzII,tunnelList.size()));
    ...
    private void recreateTZ(String entityId, TransportZone tz, InstanceIdentifier<TransportZone> tzII, int size) {
