...
public class ItmTzInstanceRecoveryHandler implements ServiceRecoveryInterface {
    ...
    public void recoverTransportZone(String entityId) throws InterruptedException {
        ...
        InstanceIdentifier<TransportZone> tzII = ItmUtils.getInstanceIdentifier(entityId);
        TransportZone tz = ItmUtils.getTransportZoneFromConfigDS(tzII.toString(), dataBroker);
        if (tz != null) {
