...
public class TepShowState implements Action {
    ...
    public TepShowState() { } // this default constructor is used by Karaf (it sets the @Reference fields)

    @Inject // this constructor is used by Guice for the simple distribution
