...
public class InterfaceConfigListener extends AsyncDataTreeChangeListenerBase<Interface, InterfaceConfigListener> {
    ...
    @Inject
    public InterfaceConfigListener(final DataBroker dataBroker, final IInterfaceManager iInterfaceManager,
    ...
    private class RendererConfigDeleteWorker implements Callable<List<ListenableFuture<Void>>> {
        InstanceIdentifier<Interface> key;
        Interface interfaceNew;

        public RendererConfigDeleteWorker(InstanceIdentifier<Interface> key, Interface interfaceNew) {
            this.key = key;
        ...
        public String toString() {
            return "RendererConfigDeleteWorker{" +
                    "key=" + key +
