...
public class TepStateRemoveWorker implements Callable<List<ListenableFuture<Void>>> {
    ...
    public TepStateRemoveWorker(final DataBroker dataBroker, final ItmTepUtils itmTepUtils, final String nodeId) {
    ...
    private CheckedFuture<Void, TransactionCommitFailedException> removeTepState() {
        ...
        InstanceIdentifier<TepState> tsIid = itmTepUtils.createTepStateIdentifier(nodeId);
