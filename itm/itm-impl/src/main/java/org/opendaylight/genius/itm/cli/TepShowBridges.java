...
import org.opendaylight.genius.itm.cache.BridgeRefEntryCache;
...
public class TepShowBridges extends OsgiCommandSupport {
    ...
    private BridgeRefEntryCache bridgeRefEntryCache;
    ...
    public void setBridgeRefEntryCache(BridgeRefEntryCache bridgeRefEntryCache) {
        this.bridgeRefEntryCache = bridgeRefEntryCache;
    }
    ...
    protected Object doExecute() {
        if (interfaceManager.isItmDirectTunnelsEnabled()) {
            ...
            Collection<BridgeRefEntry> bridgeRefEntries = bridgeRefEntryCache.getAllPresent();
            itmProvider.showBridges(bridgeRefEntries.stream()
                    .filter(dpnId == null
                            ? bridgeRefEntry -> true
                            : bridgeRefEntry -> bridgeRefEntry.getDpid().equals(dpnId))
