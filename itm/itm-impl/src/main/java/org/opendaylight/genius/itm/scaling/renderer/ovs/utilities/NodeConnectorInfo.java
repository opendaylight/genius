...
public final class NodeConnectorInfo {
    ...
    public NodeConnectorInfo(Builder builder) {
        Objects.requireNonNull(builder.nodeConnectorId, "Instance Identifier not specified for NodeConnectorInfo");
        this.nodeConnectorId = builder.nodeConnectorId;
        Objects.requireNonNull(builder.nodeConnector,
                "FlowCapable NodeConnector not specified for DpnTepInterfaceInfo");
        this.nodeConnector = builder.nodeConnector;
    }

    @Nonnull public InstanceIdentifier<FlowCapableNodeConnector> getNodeConnectorId() {
        return this.nodeConnectorId;
    }

    @Nonnull public FlowCapableNodeConnector getNodeConnector() {
