...
public class NodeConnectorInfo {
    ...
    public NodeConnectorInfo(InstanceIdentifier<FlowCapableNodeConnector> nodeConnectorId, FlowCapableNodeConnector nodeConnector) {
    ...
    public boolean equals(Object o) {
        ...
        NodeConnectorInfo that = (NodeConnectorInfo) o;

        if (getNodeConnectorId() != null ? !getNodeConnectorId().equals(that.getNodeConnectorId()) : that.getNodeConnectorId() != null)
            return false;
        return getNodeConnector() != null ? getNodeConnector().equals(that.getNodeConnector()) : that.getNodeConnector() == null;
