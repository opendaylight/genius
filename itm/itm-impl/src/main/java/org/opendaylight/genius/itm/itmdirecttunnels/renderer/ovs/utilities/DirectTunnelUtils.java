...
public final class DirectTunnelUtils {
    ...
    private final String entity = "ovsBridgeRefEntryOperation";
    ...
    @Inject
    public DirectTunnelUtils(DataBroker dataBroker, JobCoordinator jobCoordinator) {
    ...
    public List<Action> getEgressActionsForInterface(String interfaceName, Long tunnelKey, Integer actionKey,
                                                     Boolean isDefaultEgress, DpnTepStateCache dpnTepStateCache,
                                                     TunnelStateCache tunnelStateCache) {
        List<ActionInfo> listActionInfo = getEgressActionInfosForInterface(interfaceName, tunnelKey,
                actionKey == null ? 0 : actionKey, isDefaultEgress, dpnTepStateCache, tunnelStateCache);
    ...
    private List<ActionInfo> getEgressActionInfosForInterface(String interfaceName, Long tunnelKey, int actionKeyStart,
                                                             Boolean isDefaultEgress, DpnTepStateCache dpnTepStateCache,
                                                             TunnelStateCache tunnelStateCache) {
        DpnTepInterfaceInfo interfaceInfo = dpnTepStateCache.getTunnelFromConfigDS(interfaceName);
        ...
        StateTunnelList ifState = tunnelStateCache.getTunnelFromOperationalDS(interfaceName);
        if (ifState == null) {
