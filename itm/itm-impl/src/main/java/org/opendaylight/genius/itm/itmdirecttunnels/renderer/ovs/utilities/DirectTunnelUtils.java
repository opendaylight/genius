...
public final class DirectTunnelUtils {
    ...
    public void addTunnelPortToBridge(IfTunnel ifTunnel, InstanceIdentifier<?> bridgeIid,
        ...
        if (ifTunnel.isTunnelSourceIpFlow() != null && Boolean.TRUE.equals(ifTunnel.isTunnelSourceIpFlow())) {
        ...
        if (ifTunnel.isTunnelRemoteIpFlow() != null && Boolean.TRUE.equals(ifTunnel.isTunnelRemoteIpFlow())) {
