...
public final class DirectTunnelUtils {
    ...
    public List<InterfaceBfd> getBfdParams(RemoteDpns remoteDpn) {
        List<InterfaceBfd> bfdParams = new ArrayList<>();
        bfdParams.add(getIfBfdObj(BFD_PARAM_ENABLE, remoteDpn!= null ? remoteDpn.isMonitoringEnabled().toString() : "false"));
    ...
    public void updateBfdParamtersForTerminationPoint(InstanceIdentifier<?> bridgeIid, DataBroker dataBroker,
