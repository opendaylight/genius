...
public final class DirectTunnelUtils {
    ...
    private static final String BFD_PARAM_MIN_RX = "min_rx";
    private static final String BFD_PARAM_DECAY_MIN_RX = "decay_min_rx";
    private static final String BFD_PARAM_FORWARDING_IF_RX = "forwarding_if_rx";
    private static final String BFD_PARAM_CPATH_DOWN = "cpath_down";
    private static final String BFD_PARAM_CHECK_TNL_KEY = "check_tnl_key";
    ...
    public DirectTunnelUtils(DataBroker dataBroker, JobCoordinator jobCoordinator, IdManagerService idManager,
                             IMdsalApiManager mdsalApiManager, DpnTepStateCache dpnTepStateCache,
        ...
        if (interfaceBfds != null && !interfaceBfds.isEmpty()) {
            for (InterfaceBfd interfaceBfd : interfaceBfds) {
                if (interfaceBfd.getBfdKey().equalsIgnoreCase(BFD_ENABLE_KEY)) {
                    ...
                    return BFD_ENABLE_VALUE.equalsIgnoreCase(bfdEnable) ? true : false;
                }
            }
        }
        return false;
