...
public class ITMBatchHandler implements ResourceHandler {
    LogicalDatastoreType dataStoreType;
    public ITMBatchHandler(LogicalDatastoreType datastoreType){
    ...
    public DataBroker getResourceBroker() {
        return ITMBatchingUtils.getBroker();
    }

    public int getBatchSize() {
        return ITMBatchingUtils.batchSize;
    }

    public int getBatchInterval() {
        return ITMBatchingUtils.batchInterval;
    }
