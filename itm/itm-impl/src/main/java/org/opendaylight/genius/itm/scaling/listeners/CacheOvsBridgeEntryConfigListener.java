...
public class CacheOvsBridgeEntryConfigListener implements ClusteredDataTreeChangeListener<OvsBridgeEntry>{
    ...
    @Inject
    public CacheOvsBridgeEntryConfigListener(final DataBroker dataBroker, final IInterfaceManager iInterfaceManager) {
        ...
        try {
            ...
            if( iInterfaceManager.isItmDirectTunnelsEnabled()) {
                ...
                registration = dataBroker.registerDataTreeChangeListener(treeId, CacheOvsBridgeEntryConfigListener.this);
            } else {
