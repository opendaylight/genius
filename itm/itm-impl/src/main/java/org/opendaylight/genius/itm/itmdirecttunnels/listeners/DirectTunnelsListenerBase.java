...
public class DirectTunnelsListenerBase<T extends DataObject> extends AbstractClusteredSyncDataTreeChangeListener<T> {

    private static final Logger LOG = LoggerFactory.getLogger(DirectTunnelsListenerBase.class);
    ...
    public DirectTunnelsListenerBase(final DataBroker dataBroker,
