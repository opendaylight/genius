...
import org.opendaylight.genius.datastoreutils.cache.DataObjectCache;
...
public class TunnelMonitoringConfig implements AutoCloseable {
    ...
    @Inject
    public TunnelMonitoringConfig(DataBroker dataBroker) {
        tunnelMonitorIntervalCache = new DataObjectCache<>(dataBroker, LogicalDatastoreType.CONFIGURATION,
                TUNNEL_MONITOR_INTERVAL_PATH);
        tunnelMonitorParamsCache = new DataObjectCache<>(dataBroker, LogicalDatastoreType.CONFIGURATION,
                TUNNEL_MONITOR_PARAMS_PATH);
    }
