...
public final class TunnelEndPointInfo {
    ...
    public TunnelEndPointInfo(Builder builder) {
        Objects.requireNonNull(builder.srcEndPointInfo, "source end point info not specified for tunnelEndPointInfo");
        this.srcEndPointInfo  = builder.srcEndPointInfo;
        Objects.requireNonNull(builder.dstEndPointInfo, "dest end point info not specified for tunnelEndPointInfo");
        this.dstEndPointInfo = builder.dstEndPointInfo;
    }

    @Nonnull public String getDstDpnId() {
        return dstEndPointInfo;
    }

    @Nonnull public String getSrcDpnId() {
