...
public class TunnelEndPointInfo {
    String srcEndPointInfo;
    String dstEndPointInfo;
    ...
    public boolean equals(Object o) {
        ...
        TunnelEndPointInfo that = (TunnelEndPointInfo) o;

        if (!getSrcDpnId().equals(that.getSrcDpnId())) return false;
