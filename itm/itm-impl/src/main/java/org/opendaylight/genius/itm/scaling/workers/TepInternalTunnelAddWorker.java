...
public class TepInternalTunnelAddWorker {
    ...
    private static void buildTunnelFrom(DPNTEPsInfo srcDpn, List<DPNTEPsInfo> meshedDpnList,
    ...
    private static boolean wireUp(TunnelEndPoints srcte, TunnelEndPoints dstte,
        ...
        LOG.debug(  " Creating Trunk Interface with parameters trunk I/f Name - {}, parent I/f name - {}, source IP - {}, destination IP - {} gateway IP - {}",trunkInterfaceName, interfaceName, srcte.getIpAddress(), dstte.getIpAddress(), gwyIpAddress ) ;

        Interface iface = ItmUtils.buildTunnelInterface(srcDpn.getDPNID(), trunkInterfaceName,
                String.format( "%s %s",ItmUtils.convertTunnelTypetoString(srcte.getTunnelType()),
                        "Trunk Interface"), true, tunType, srcte.getIpAddress(), dstte.getIpAddress(), gwyIpAddress,
                srcte.getVLANID(), true, monitorEnabled, monitorProtocol, monitorInterval, false, null);
        ...
        DpnTepsStateBuilder dpnTepsStateBuilder = new DpnTepsStateBuilder();
        List<RemoteDpns> remoteDpns = new ArrayList<RemoteDpns>();
        DpnsTepsBuilder  dpnsTepsBuilder = new DpnsTepsBuilder();
        List<DpnsTeps> dpnTeps = new ArrayList<DpnsTeps>();
        ...
        remoteDpn.setMonitorEnabled(monitorEnabled);
