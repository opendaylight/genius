...
public class VtepRemoveWorker implements Callable<List<ListenableFuture<Void>>> {
    ...
    private CheckedFuture<Void, TransactionCommitFailedException> removeOvsdbVtep() {
    ...
    private void removeOvsdbTep(Vteps srcVtep, Vteps dstVtep) {
        ...
        removeOvsdbTunnel(srcVtep.getNodeId(), portName);
    ...
    private void removeOvsdbTunnel(String nodeId, String portName) {
