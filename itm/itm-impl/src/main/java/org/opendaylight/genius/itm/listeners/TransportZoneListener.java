        ...
        if (allowTunnelDeletion) {
            ...
            if (!opDpnList.isEmpty() || !hwVtepList.isEmpty()) {
                if (iInterfaceManager.isItmDirectTunnelsEnabled()) {
                    ...
                    TepInterfaceRemoveWorker tepInterfaceRemoveWorker = new TepInterfaceRemoveWorker(opDpnList, hwVtepList,
                        transportZone, dataBroker, idManagerService, mdsalManager,dpnTEPsInfoCache, tunnelMonitoringConfig, tunnelStateCache);
    ...
    public void update(@Nonnull TransportZone originalTransportZone, @Nonnull TransportZone updatedTransportZone) {
        ...
        if (!newDpnTepsList.isEmpty()) {
            ...
            if (iInterfaceManager.isItmDirectTunnelsEnabled()) {
                ...
                TepInterfaceAddWorker tepInterfaceAddWorker = new TepInterfaceAddWorker(newDpnTepsList,
                    Collections.emptyList(),dataBroker, idManagerService, mdsalManager, itmConfig, dpnTEPsInfoCache, tunnelMonitoringConfig);
        ...
        if (!newHwList.isEmpty()) {
            ...
            if (iInterfaceManager.isItmDirectTunnelsEnabled()) {
                LOG.trace( "HWTEP UPDATE:ITM Direct Tunnel is enabled");
                TepInterfaceAddWorker tepInterfaceAddWorker = new TepInterfaceAddWorker(Collections.emptyList(),
                    newHwList,dataBroker, idManagerService, mdsalManager, itmConfig, dpnTEPsInfoCache, tunnelMonitoringConfig);
                jobCoordinator.enqueueJob(updatedTransportZone.getZoneName(), tepInterfaceAddWorker);
            } else {
