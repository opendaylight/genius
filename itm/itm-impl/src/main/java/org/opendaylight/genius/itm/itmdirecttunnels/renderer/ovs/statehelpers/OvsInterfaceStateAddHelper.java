...
import org.opendaylight.genius.itm.itmdirecttunnels.renderer.ovs.utilities.ItmScaleUtils;
    ...
    public static List<ListenableFuture<Void>> addState(DataBroker dataBroker, IdManagerService idManager,
        ...
        if (tunnelEndPointInfo != null) {
            DpnTepInterfaceInfo dpnTepConfigInfo =
                    dpnTepStateCache.getDpnTepInterfaceFromCache(tunnelEndPointInfo.getSrcEndPointInfo(),
