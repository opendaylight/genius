...
@Singleton
public final class VniUtils {

    private static final Logger LOG = LoggerFactory.getLogger(VniUtils.class);
    ...
    @Inject
    public VniUtils(NetworkConfig networkConfig,
    ...
    public IdPool getVxlanVniPool() throws ReadFailedException {
