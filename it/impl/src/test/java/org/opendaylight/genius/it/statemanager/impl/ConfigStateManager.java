...
package org.opendaylight.genius.it.statemanager.impl;
...
public class ConfigStateManager {
    ...
    private static final int MODULE_TIMEOUT_SECONDS = 60;
    private static final int RETRY_TIMEOUT_SECONDS = 5;
    public StateManager stateManager;

    public ConfigStateManager(StateManager stateManager) {
        this.stateManager = stateManager;
    }

    private void initReady() {
        readyMap.put("interfacemanager-impl", Pair.of("interfacemanager-default", false));
        readyMap.put("itm", Pair.of("itm-default", false));
        readyMap.put("idmanager-impl", Pair.of("idmanager-default", false));
    }
