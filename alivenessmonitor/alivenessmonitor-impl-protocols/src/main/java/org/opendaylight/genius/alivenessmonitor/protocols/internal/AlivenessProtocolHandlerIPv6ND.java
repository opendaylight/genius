...
public class AlivenessProtocolHandlerIPv6ND extends AbstractAlivenessProtocolHandler<Packet> {
    ...
    public void startMonitoringTask(MonitoringInfo monitorInfo) {
        ...
        ListenableFuture<RpcResult<SendNeighborSolicitationOutput>> future =
                (ListenableFuture<RpcResult<SendNeighborSolicitationOutput>>)ndService.sendNeighborSolicitation(input);
