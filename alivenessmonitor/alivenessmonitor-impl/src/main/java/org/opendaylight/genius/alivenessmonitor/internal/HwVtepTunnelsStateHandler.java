...
public class HwVtepTunnelsStateHandler extends AbstractSyncDataTreeChangeListener<Tunnels>
    ...
    private void fillBfdParams(List<BfdParams> bfdParams, MonitorProfile profile) {
        ...
        bfdParams.add(getBfdParams(AlivenessMonitorConstants.BFD_PARAM_MIN_RX, Long.toString(profile.getMinRx().toJava())));
        bfdParams.add(getBfdParams(AlivenessMonitorConstants.BFD_PARAM_MIN_TX, Long.toString(profile.getMinTx().toJava())));
        bfdParams.add(
                getBfdParams(AlivenessMonitorConstants.BFD_PARAM_DECAY_MIN_RX, Long.toString(profile.getDecayMinRx().toJava())));
