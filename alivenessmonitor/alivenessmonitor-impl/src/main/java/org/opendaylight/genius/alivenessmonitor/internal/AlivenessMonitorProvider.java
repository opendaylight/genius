...
public class AlivenessMonitorProvider implements BindingAwareProvider,
    ...
    public void onSessionInitiated(ProviderContext session) {
        ...
        try {
            ...
            // BFD Hwvtep tunnel handler
            HwVtepTunnelsStateHandler bfdHandler = new HwVtepTunnelsStateHandler(alivenessMonitor);
            alivenessMonitor.registerHandler(EtherTypes.Bfd, bfdHandler);
