...
public final class IfmCLIUtil {
    ...
    static void showBfdStateToTpHeader(CommandSession session) {
        StringBuilder sb = new StringBuilder();
        Formatter fmt = new Formatter(sb);
    ...
    static void showBfdStateToTpOutput(String ifName, org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf
