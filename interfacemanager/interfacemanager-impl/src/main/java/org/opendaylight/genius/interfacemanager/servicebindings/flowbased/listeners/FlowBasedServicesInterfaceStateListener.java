    ...
    protected void remove(InstanceIdentifier<Interface> key, Interface interfaceStateOld) {
        IfmClusterUtils.runOnlyInLeaderNode(() -> {
            ...
            for (Object serviceMode : FlowBasedServicesUtils.SERVICE_MODE_MAP.values()) {
                ...
                RendererStateInterfaceUnbindWorker stateUnbindWorker = new RendererStateInterfaceUnbindWorker(flowBasedServicesStateRemovable, interfaceStateOld);
    ...
    protected void add(InstanceIdentifier<Interface> key, Interface interfaceStateNew) {
        IfmClusterUtils.runOnlyInLeaderNode(() -> {
            ...
            for (Object serviceMode : FlowBasedServicesUtils.SERVICE_MODE_MAP.values()) {
                ...
                RendererStateInterfaceBindWorker stateBindWorker = new RendererStateInterfaceBindWorker(flowBasedServicesStateAddable, interfaceStateNew);
