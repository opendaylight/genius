...
public class InterfaceManagerProvider implements BindingAwareProvider, AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(InterfaceManagerProvider.class);

    @Override
    public void onSessionInitiated(ProviderContext session) {
        LOG.info("InterfaceManagerProvider Session Initiated");
    }

    @Override
    public void close() throws Exception {
        LOG.info("InterfaceManagerProvider Closed");
    }
