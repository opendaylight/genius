...
public class FlowBasedEgressServicesConfigUnbindHelper implements FlowBasedServicesConfigRemovable {
    ...
    private static List<ListenableFuture<Void>> unbindServiceOnVlan(
        ...
        if (boundServices.isEmpty()) {
            ...
            FlowBasedServicesUtils.removeEgressDispatcherFlow(dpId, ifaceState.getName(), boundServiceOld, t, IfmConstants.DEFAULT_SERVICE_INDEX);
            if (t != null) {
        ...
        if (high == null) {
            ...
            if (low != null) {
                ...
                FlowBasedServicesUtils.installEgressDispatcherFlow(dpId, low, ifaceState.getName(), t, ifaceState.getIfIndex(), IfmConstants.DEFAULT_SERVICE_INDEX, lowerServiceIndex);
            }
        } else {
            ...
            if (high.equals(highest)) {
                FlowBasedServicesUtils.installEgressDispatcherFlow(dpId, high, ifaceState.getName(),t, ifaceState.getIfIndex(), IfmConstants.DEFAULT_SERVICE_INDEX, lowerServiceIndex);
            } else {
