...
public class HwVTEPTunnelsStateListener
    ...
    @Override
    protected void updated(final InstanceIdentifier<Tunnels> identifier, final Tunnels tunnelOld, final Tunnels tunnelNew) {
        LOG.debug("Received Update Tunnel Update Notification for identifier: {}", identifier);
        final RendererStateUpdateWorker rendererStateUpdateWorker = new RendererStateUpdateWorker(identifier, tunnelOld);
