...
public class InterfacemgrProvider implements BindingAwareProvider, AutoCloseable, IInterfaceManager {
    ...
    public void onSessionInitiated(ProviderContext session) {
        ...
        try {
            ...
            interfaceConfigListener = new InterfaceConfigListener(dataBroker, idManager, alivenessManager, mdsalManager, this);
            ...
            terminationPointStateListener = new TerminationPointStateListener(dataBroker, this);
    ...
    public void updateInterfaceParentRef(String interfaceName, String parentInterface) {
        ...
        // This uses the same DJC key as NeutronPortChangeListener to attempt to prevent write lock contention
        jobCoordinator.enqueueJob("PORT- " + interfaceName, parentRefUpdateWorker, IfmConstants.JOB_MAX_RETRIES);
    }
