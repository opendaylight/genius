...
public class InterfaceTopologyStateListener
    ...
    @Override
    protected void remove(final InstanceIdentifier<OvsdbBridgeAugmentation> identifier,
        ...
        runOnlyInOwnerNode("OVSDB bridge removed", () -> {
            final RendererStateRemoveWorker rendererStateRemoveWorker =
    ...
    @Override
    protected void update(final InstanceIdentifier<OvsdbBridgeAugmentation> identifier,
                          final OvsdbBridgeAugmentation bridgeOld,
        ...
        runOnlyInOwnerNode("OVSDB bridge updated", () -> {
            ...
            if (oldDpid == null && newDpid != null) {
                ...
                final RendererStateUpdateWorker rendererStateAddWorker =
    ...
    @Override
    protected void add(final InstanceIdentifier<OvsdbBridgeAugmentation> identifier,
                       final OvsdbBridgeAugmentation bridgeNew) {
