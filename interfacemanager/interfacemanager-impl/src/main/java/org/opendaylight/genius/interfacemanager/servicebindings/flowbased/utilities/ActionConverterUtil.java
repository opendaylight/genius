...
public final class ActionConverterUtil {
    private static final Map<Class<? extends Action>, Function<Action, Action>> SERVICE_TO_OF =
            ...
            .put(ServiceBindingNxActionPopNshApplyActionsCase.class,
                input -> new NxActionPopNshNodesNodeTableFlowApplyActionsCaseBuilder(
                    (ServiceBindingNxActionPopNshApplyActionsCase) input).build())
            .put(ServiceBindingNxActionPushNshApplyActionsCase.class,
                input -> new NxActionPushNshNodesNodeTableFlowApplyActionsCaseBuilder(
                    (ServiceBindingNxActionPushNshApplyActionsCase) input).build())
            ...
            .put(ServiceBindingNxActionPopNshWriteActionsCase.class,
                input -> new NxActionPopNshNodesNodeTableFlowWriteActionsCaseBuilder(
                    (ServiceBindingNxActionPopNshWriteActionsCase) input).build())
            .put(ServiceBindingNxActionPushNshWriteActionsCase.class,
                input -> new NxActionPushNshNodesNodeTableFlowWriteActionsCaseBuilder(
                    (ServiceBindingNxActionPushNshWriteActionsCase) input).build())
