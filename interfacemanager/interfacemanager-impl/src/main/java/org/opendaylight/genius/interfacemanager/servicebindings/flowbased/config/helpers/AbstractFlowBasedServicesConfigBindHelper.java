...
public abstract class AbstractFlowBasedServicesConfigBindHelper implements FlowBasedServicesConfigAddable {
    ...
    protected abstract List<ListenableFuture<Void>> bindServiceOnVlan(BoundServices boundServiceNew,
                                                                      List<BoundServices> allServices,
                                                                      Interface ifState, DataBroker dataBroker);

    protected abstract List<ListenableFuture<Void>> bindServiceOnTunnel(BoundServices boundServiceNew,
                                                                        List<BoundServices> allServices,
                                                                        Interface ifState, DataBroker dataBroker);
