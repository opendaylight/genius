...
public class FlowBasedEgressServicesConfigBindHelper extends AbstractFlowBasedServicesConfigBindHelper {
    ...
    private FlowBasedEgressServicesConfigBindHelper(DataBroker dataBroker, InterfacemgrProvider interfacemgrProvider) {
        super(dataBroker, interfacemgrProvider);
    }

    public static void intitializeFlowBasedEgressServicesConfigAddHelper(DataBroker dataBroker, InterfacemgrProvider
            interfaceMgrProvider) {
        if (flowBasedEgressServicesAddable == null) {
            synchronized (FlowBasedEgressServicesConfigBindHelper.class) {
                if (flowBasedEgressServicesAddable == null) {
                    flowBasedEgressServicesAddable =
                            new FlowBasedEgressServicesConfigBindHelper(dataBroker, interfaceMgrProvider);
                }
            }
        }
    }
