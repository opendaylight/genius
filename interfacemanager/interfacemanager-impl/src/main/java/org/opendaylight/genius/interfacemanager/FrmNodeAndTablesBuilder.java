...
public class FrmNodeAndTablesBuilder implements ReconciliationNotificationListener {
    ...
    private boolean preCreateInventoryNodeAndTables(DeviceInfo connectedNode, int maxRetries,
        ...
        BigInteger dpnId = getDpnIdFromNodeIdent(connectedNode);
    ...
    private BigInteger getDpnIdFromNodeIdent(final DeviceInfo nodeIdentity) {
        BigInteger nodeName = nodeIdentity.getDatapathId();
        return nodeName;
    }
