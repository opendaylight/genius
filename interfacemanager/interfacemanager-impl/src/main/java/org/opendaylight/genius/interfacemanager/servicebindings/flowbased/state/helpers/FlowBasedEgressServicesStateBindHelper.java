...
public class FlowBasedEgressServicesStateBindHelper extends AbstractFlowBasedServicesStateBindHelper {
    ...
    private FlowBasedEgressServicesStateBindHelper(DataBroker dataBroker, InterfacemgrProvider interfaceMgrProvider) {
        super(dataBroker, interfaceMgrProvider);

    }

    public static void intitializeFlowBasedEgressServicesStateBindHelper(DataBroker dataBroker, InterfacemgrProvider
            interfaceMgrProvider) {
        if (flowBasedServicesStateAddable == null) {
            synchronized (FlowBasedEgressServicesStateBindHelper.class) {
                if (flowBasedServicesStateAddable == null) {
                    flowBasedServicesStateAddable = new FlowBasedEgressServicesStateBindHelper(dataBroker,
                            interfaceMgrProvider);
                }
            }
        }
