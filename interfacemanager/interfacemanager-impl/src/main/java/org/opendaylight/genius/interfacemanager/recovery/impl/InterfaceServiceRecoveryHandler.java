...
public class InterfaceServiceRecoveryHandler implements ServiceRecoveryInterface {
    ...
    @Inject
    public InterfaceServiceRecoveryHandler(ServiceRecoveryRegistry serviceRecoveryRegistry) {
    ...
    public void removeRecoverableListener(RecoverableListener recoverableListener) {
        recoverableListeners.add(recoverableListener);
    }
