...
public class InterfaceServiceRecoveryHandler implements ServiceRecoveryInterface {
    ...
    private final InterfaceTopologyStateListener interfaceTopologyStateListener;
    private final TerminationPointStateListener terminationPointStateListener;
    private final FlowBasedServicesConfigListener flowBasedServicesConfigListener;
    private final FlowBasedServicesInterfaceStateListener flowBasedServicesInterfaceStateListener;
    private final HwVTEPTunnelsStateListener hwVTEPTunnelsStateListener;
