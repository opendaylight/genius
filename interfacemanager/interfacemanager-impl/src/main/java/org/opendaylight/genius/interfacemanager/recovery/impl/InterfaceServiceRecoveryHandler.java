...
public class InterfaceServiceRecoveryHandler implements ServiceRecoveryInterface {
    ...
    public boolean recoverService(String entityName, String entityType, String entityId) {
        LOG.info("recover interface - WIP");
        return true;
    }

    private String buildServiceRegistryKey() {
        return new StringBuilder(ServiceRecoveryConstants.SERVICE_PREFIX).append(ServiceRecoveryConstants
            .SERVICE_ENTITY_NAME_SEPARATOR).append(ServiceRecoveryConstants.SERVICE_NAME).toString();
    }
}
