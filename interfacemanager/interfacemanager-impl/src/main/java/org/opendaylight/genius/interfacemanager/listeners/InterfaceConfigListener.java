...
public class InterfaceConfigListener extends AsyncClusteredDataTreeChangeListenerBase<Interface, InterfaceConfigListener> {
    ...
    private ParentRefs updateInterfaceParentRefs(Interface iface) {
        ...
        return new ParentRefsBuilder().setParentInterface(parentRefName).build();
    }

    private ParentRefs guessParentRefsForNonTunnels(boolean isTunnelInterface, ParentRefs parentRefs) {
