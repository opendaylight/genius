    ...
    public static List<ActionInfo> getEgressActionInfosForInterface(Interface interfaceInfo,
        ...
        switch (ifaceType) {
            ...
            case LOGICAL_GROUP_INTERFACE:
                if (isDefaultEgress) {
                    LOG.debug("MULTIPLE_VxLAN_TUNNELS: getEgressActionInfosForInterface - default egress case");
                    result.add(new ActionGroup(Long.valueOf(portNo)));
                } else {
                    LOG.debug("MULTIPLE_VxLAN_TUNNELS: getEgressActionInfosForInterface");
