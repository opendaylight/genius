...
public class OvsInterfaceStateUpdateHelper {
    ...
    @Inject
    public OvsInterfaceStateUpdateHelper(ManagedNewTransactionRunner txRunner,
            AlivenessMonitorUtils alivenessMonitorUtils, InterfaceManagerCommonUtils interfaceManagerCommonUtils) {
