...
public abstract class AbstractFlowBasedServicesStateUnbindHelper implements FlowBasedServicesStateRemovable {
    ...
    protected abstract List<ListenableFuture<Void>> unbindServiceOnVlan(List<BoundServices> allServices,
                                                                        Interface ifState, Integer ifIndex,
                                                                        DataBroker dataBroker);

    protected abstract List<ListenableFuture<Void>> unbindServiceOnTunnel(List<BoundServices> allServices,
                                                                          Interface ifState, Integer ifIndex,
                                                                          DataBroker dataBroker);
}
