...
public abstract class AbstractFlowBasedServicesStateUnbindHelper implements FlowBasedServicesStateRemovable {
     ...
     */
    public AbstractFlowBasedServicesStateUnbindHelper(DataBroker dataBroker,
    ...
    @Override
    public void unbindServices(List<ListenableFuture<Void>> futures, Interface ifaceState,
        ...
        if (L2vlan.class.equals(ifaceState.getType()) || Tunnel.class.equals(ifaceState.getType())) {
            unbindServicesOnInterface(futures, allServices, ifaceState, ifaceState.getIfIndex(), dataBroker);
        }
    }
