...
public abstract class AbstractFlowBasedServicesStateUnbindHelper implements FlowBasedServicesStateRemovable {
    ...
    public abstract List<ListenableFuture<Void>> unbindServicesFromInterface(List<BoundServices> allServices,
                                                                                Interface ifState,
                                                                                Integer ifIndex, DataBroker dataBroker);

    public abstract List<ListenableFuture<Void>> unbindServicesFromInterfaceType(BigInteger dpnId, String ifaceName,
