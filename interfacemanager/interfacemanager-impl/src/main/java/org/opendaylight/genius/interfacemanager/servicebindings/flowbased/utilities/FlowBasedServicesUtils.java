...
public class FlowBasedServicesUtils {
    ...
    /**
     * Build the list of MatchInfo for the dispatcher table.
     *
     * @deprecated Use {@link #getMatchInfoForDispatcherTable(int, short)}.
     */
    @Deprecated
    public static List<MatchInfo> getMatchInfoForDispatcherTable(BigInteger dpId, int interfaceTag,
            short servicePriority) {
        return getMatchInfoForDispatcherTable(interfaceTag, servicePriority);
    }
    ...
    /**
     * Remove the egress flows.
     *
     * @deprecated Use {@link #removeEgressDispatcherFlows(BigInteger, String, WriteTransaction, short)}?
     */
    @Deprecated
    public static void removeEgressDispatcherFlows(BigInteger dpId, String iface, BoundServices boundServicesOld,
            WriteTransaction writeTransaction, short currentServiceIndex) {
        removeEgressDispatcherFlows(dpId, iface, writeTransaction, currentServiceIndex);
    }
    ...
    /**
     * Remove the egress split-horizon flow.
     *
     * @deprecated Use {@link #removeEgressSplitHorizonDispatcherFlow(BigInteger, String, WriteTransaction)}.
     */
    @Deprecated
