...
public class FlowBasedServicesUtils {
    ...
    public static void installEgressDispatcherSplitHorizonFlow(BigInteger dpId, BoundServices boundService,
        ...
        String serviceRef = boundService.getServiceName();
        int splitHorizonFlowPriority = boundService.getServicePriority() + 1; // this
                                                                                // must
                                                                                // be
                                                                                // higher
                                                                                // priority
    ...
    public static BoundServices[] getHighAndLowPriorityService(List<BoundServices> serviceInfos,
        ...
        BoundServices higher = null; // this will be used to hold the immediate
                                        // higher service priority with respect
                                        // to the currentServiceInfo
        BoundServices lower = null; // this will be used to hold the immediate
                                    // lower service priority with respect to
                                    // the currentServiceInfo
