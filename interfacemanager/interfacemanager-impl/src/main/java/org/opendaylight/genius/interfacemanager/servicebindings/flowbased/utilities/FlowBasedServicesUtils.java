...
public class FlowBasedServicesUtils {
    ...
    public static void bindDefaultEgressDispatcherService(DataBroker dataBroker, List<ListenableFuture<Void>> futures,
        ...
        List<Instruction> instructions = IfmUtil.getEgressInstructionsForInterface(interfaceInfo, portNo, null, true, ifIndex, 0);
    ...
    public static void bindDefaultEgressDispatcherService(DataBroker dataBroker, List<ListenableFuture<Void>> futures,
        ...
        List<Instruction> instructions = IfmUtil.getEgressInstructionsForInterface(interfaceInfo, StringUtils.EMPTY,
                                                                                   null, true, ifIndex, groupId);
        bindDefaultEgressDispatcherService(dataBroker, futures, interfaceName, instructions);
    }
