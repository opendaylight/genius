...
public class FlowBasedServicesUtils {
    ...
    public static void removeTypeBasedEgressDispatcherFlows(BigInteger dpId, WriteTransaction writeTransaction,
                                                            String iface, short servicePriority) {
        LOG.debug("Removing Egress Dispatcher Flows {}, for type {}", dpId, iface);
        removeTypeBasedEgressDispatcherFlow(dpId, writeTransaction, iface, servicePriority);
    }

    private static void removeTypeBasedEgressDispatcherFlow(BigInteger dpId, WriteTransaction writeTransaction,
                                                            String iface, short servicePriority) {
        // build the flow and install it
        String flowRef = getFlowRef(dpId, NwConstants.EGRESS_LPORT_DISPATCHER_TABLE, iface,
                servicePriority);
