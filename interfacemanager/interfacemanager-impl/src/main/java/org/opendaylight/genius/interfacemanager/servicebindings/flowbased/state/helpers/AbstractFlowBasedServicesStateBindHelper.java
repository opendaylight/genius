...
public abstract class AbstractFlowBasedServicesStateBindHelper implements FlowBasedServicesStateAddable {
    ...
    /**
     * Create instance.
     * @param interfaceMgrProvider handle to interfacemgrProvider class
     */
    ...
    protected abstract List<ListenableFuture<Void>> bindServiceOnVlan(List<BoundServices> allServices,
                                                                      Interface ifState,
                                                                      DataBroker dataBroker);

    protected abstract List<ListenableFuture<Void>> bindServiceOnTunnelInterface(List<BoundServices> allServices,
                                                                                 Interface ifState,
                                                                                 DataBroker dataBroker);
}
