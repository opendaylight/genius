...
import org.opendaylight.genius.interfacemanager.test.infra.TestAlivenessMonitorService;
...
public class InterfaceManagerTestModule extends AbstractGuiceJsr250Module {
    ...
    protected void configureBindings() throws Exception {
        ...
        AlivenessMonitorService alivenessMonitorService = TestAlivenessMonitorService.newInstance();
        bind(AlivenessMonitorService.class).toInstance(alivenessMonitorService);
