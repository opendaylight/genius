...
public class InterfaceManagerTestUtil {
    ...
    public static final String trunkMemberinterfaceName = "23701c04-7e58-4c65-9425-78a80d49a219";
    ...
    public static org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.node.NodeConnector
    ...
    public static FlowCapableNodeConnector buildFlowCapableNodeConnector(boolean isPortDown, boolean isLive,
    ...
    public static InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.node.NodeConnector> buildNodeConnectorInstanceIdentifier(BigInteger dpn, long portNo) {
    ...
    public static void updateInterfaceAdminState(DataBroker dataBroker, String ifaceName, boolean isEnabled){
        InstanceIdentifier<Interface> vlanInterfaceEnabledInterfaceInstanceIdentifier = IfmUtil.buildId(
            ifaceName);
    ...
    public static void updateTunnelMonitoringAttributes(DataBroker dataBroker, String ifaceName){
    ...
    public static void putInterfaceConfig(DataBroker dataBroker, String ifaceName, ParentRefs parentRefs,
        ...
        if(!Tunnel.class.equals(ifType)) {
            interfaceInfo = InterfaceManagerTestUtil.buildInterface(
                    ifaceName, ifaceName, true, ifType, parentRefs.getParentInterface(), IfL2vlan.L2vlanMode.Trunk);
        }else{
    ...
    public static void putVlanInterfaceConfig(DataBroker dataBroker, String ifaceName, String parentRefs,
    ...
    public static void createFlowCapableNodeConnector(DataBroker dataBroker, String interfaceName,
                                                      Class<? extends InterfaceType> ifType){
        WriteTransaction tx = dataBroker.newWriteOnlyTransaction();
