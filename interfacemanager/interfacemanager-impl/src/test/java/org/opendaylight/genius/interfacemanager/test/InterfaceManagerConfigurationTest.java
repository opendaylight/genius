...
public class InterfaceManagerConfigurationTest {
    ...
    private void checkVlanApis() throws Exception {
        ...
        // FIXME need to wait for https://git.opendaylight.org/gerrit/#/c/54811/ to land
        ...
        Assert.assertNotNull(dataBroker.newReadOnlyTransaction().read(LogicalDatastoreType.CONFIGURATION, IfmUtil.buildId(
            INTERFACE_NAME_1)).checkedGet().get());
        ...
        Assert.assertNotNull(dataBroker
            .newReadOnlyTransaction().read(LogicalDatastoreType.CONFIGURATION, IfmUtil
                .buildId(INTERFACE_NAME_1)).checkedGet().get().getAugmentation(ParentRefs.class));
