...
public class InterfaceManagerConfigurationTest {
    ...
    private void checkVlanApis() throws Exception {
        ...
        assertEqualBeans(ExpectedInterfaceInfo.newVlanInterfaceInfo(), interfaceManager.getInterfaceInfo
            (INTERFACE_NAME));
    ...
    private void checkTunnelApis() throws  Exception {
        ...
        assertEqualBeans(ExpectedTerminationPoint.newTerminationPointList(), interfaceManager.getPortsOnBridge
            (DPN_ID_2));

        // 2. fetch get all tunnel ports on bridge
        assertEqualBeans(ExpectedTerminationPoint.newTerminationPointList(), interfaceManager.getTunnelPortsOnBridge
            (DPN_ID_2));
