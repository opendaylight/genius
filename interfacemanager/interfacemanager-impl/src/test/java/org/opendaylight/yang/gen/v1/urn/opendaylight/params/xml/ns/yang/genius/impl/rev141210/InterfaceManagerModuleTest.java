...
public class InterfaceManagerModuleTest {
    @Test
    public void testCustomValidation() {
        InterfaceManagerModule module = new InterfaceManagerModule(mock(ModuleIdentifier.class), mock(DependencyResolver.class));
    ...
    public void testCreateInstance() throws Exception {
        ...
        InterfaceManagerModule module = new InterfaceManagerModule(mock(ModuleIdentifier.class), dependencyResolver);

        // getInstance calls resolveInstance to get the broker dependency and then calls createInstance
        AutoCloseable closeable = module.getInstance();

        // verify that the module registered the returned provider with the broker
        verify(broker).registerProvider((InterfaceManagerProvider)closeable);
