...
-----------------------------------------
Verify selective BFD monitoring can be enabled for OF tunnels.
...
Configure the tunnel monitoring to BFD.
   ...
   #. Delete TEP local ip address from switch_1.
       ...
       * verify the parent-child interface mapping is removed from dpn-teps-state DS.
       * verify dpn-teps-state datastore is cleaned up
...
-------------------------------------------
Verify selective BFD monitoring can be disabled for OF tunnels.
...
Configure the tunnel monitoring to BFD.
 ...
 Note : When BFD is disabled toggling of interface state should not reflect in tep-show state.
