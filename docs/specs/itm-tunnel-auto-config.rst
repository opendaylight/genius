...
``def-tz-enabled`` is ``true`` in ``genius-itm-config.xml`` file. When created, default
transport zone is configured with:
...
Optional                  TEP IP-Address

Deprecated                Subnet prefix, Dpn-id, Gateway-ip, Vlan-id, Portname
====================      =======================================================
