...
public class GeniusModuleTest {
    @Test
    public void testCustomValidation() {
        GeniusModule module = new GeniusModule(mock(ModuleIdentifier.class), mock(DependencyResolver.class));
    ...
    public void testCreateInstance() throws Exception {
        ...
        GeniusModule module = new GeniusModule(mock(ModuleIdentifier.class), dependencyResolver);

        // getInstance calls resolveInstance to get the broker dependency and then calls createInstance
        AutoCloseable closeable = module.getInstance();

        // verify that the module registered the returned provider with the broker
        verify(broker).registerProvider((GeniusProvider)closeable);
