...
public class UpgradeUtils {
    ...
    private final UpgradeConfig upgradeConfiguration;

    @Inject
    public UpgradeUtils(@OsgiService final DataBroker dataBroker, final UpgradeConfig upgradeConfig) {
        this.dataBroker = dataBroker;
        this.txRunner = new RetryingManagedNewTransactionRunner(dataBroker);
        this.upgradeConfiguration = upgradeConfig;
    }
