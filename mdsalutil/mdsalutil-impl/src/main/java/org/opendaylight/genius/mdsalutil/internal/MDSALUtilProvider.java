...
public class MDSALUtilProvider implements BindingAwareConsumer, IMdsalApiManager, AutoCloseable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MDSALUtilProvider.class);
    private MDSALManager mdSalMgr;
    private static final long FIXED_DELAY_IN_MILLISECONDS = 5000;

    @Override
    public void onSessionInitialized(ConsumerContext session) {
        LOGGER.info( " Session Initiated for MD SAL Util Provider") ;
        ...
        try {
            ...
            LOGGER.error( "Error initializing MD SAL Util Services " + e );
        }
    }
    ...
    public void close() throws Exception {
        mdSalMgr.close();
        LOGGER.info("MDSAL Manager Closed");
    }
