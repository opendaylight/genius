...
public class NWUtil {
    ...
    */
    ...
    public static String toIpPrefix(String ipAddress) {
        StringBuilder IpPrefixBuild = new StringBuilder(ipAddress);
        final String ipPrefix = (isIpv4Address(ipAddress)) ? IpPrefixBuild.append("/32").toString() :
                                 IpPrefixBuild.append("/128").toString();
        return ipPrefix;
    }
}
