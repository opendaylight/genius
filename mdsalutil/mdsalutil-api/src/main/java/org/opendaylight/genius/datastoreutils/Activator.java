...
public class Activator implements BundleActivator {
    ...
    public void stop(BundleContext context) throws Exception {
        ...
        AsyncClusteredDataChangeListenerBase.destroy();
        AsyncDataChangeListenerBase.destroy();
        AsyncDataTreeChangeListenerBase.destroy();
        AsyncClusteredDataTreeChangeListenerBase.destroy();
    }
