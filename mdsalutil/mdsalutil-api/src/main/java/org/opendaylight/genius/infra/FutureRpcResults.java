...
public final class FutureRpcResults {
    ...
    public enum LogLevel {
        ...
        /**
         * Note that when using LogLevel NONE, then should set a
         * {@link FutureRpcResultBuilder#onFailure(Consumer)} which does better logging,
         * or be 100% that all callers of the RPC check the returned Future RpcResult appropriately;
         * otherwise you will loose error messages.
         */
        NONE;
