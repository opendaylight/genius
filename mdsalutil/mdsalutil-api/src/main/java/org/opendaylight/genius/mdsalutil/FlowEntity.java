...
public abstract class FlowEntity extends AbstractSwitchEntity {
    ...
    // TODO discuss & get agreement if cookie is mandatory.. and this default is OK?
    // This was done because MDSALManager has this hard-coded like this, upon installFlow
    @Default
    ...
    // TODO discuss & get agreement if flowName should be mandatory or not?
