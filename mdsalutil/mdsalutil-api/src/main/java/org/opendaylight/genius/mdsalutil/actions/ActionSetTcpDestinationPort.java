...
public class ActionSetTcpDestinationPort extends ActionInfo {
    ...
    public ActionSetTcpDestinationPort(int portNumber) {
        super(ActionType.set_tcp_destination_port, new String[] {Integer.toString(portNumber)});
        this.portNumber = portNumber;
    }

    @Deprecated
    public ActionSetTcpDestinationPort(String[] actionValues) {
        super(ActionType.set_tcp_destination_port, actionValues);
