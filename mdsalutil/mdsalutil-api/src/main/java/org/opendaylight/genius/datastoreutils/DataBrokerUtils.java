...
public class DataBrokerUtils {
    ...
    @Inject
    public DataBrokerUtils(DataBroker broker) {
        super();
        this.broker = broker;
    }

    /**
     * Synchronously read; preferred & strongly recommended method.
     *
     * @param store
     ...
     *
     * @see {@link ReadTransaction#read(LogicalDatastoreType, InstanceIdentifier)}
     */
     ...
     * @throws ReadFailedException in case of a technical (!) error while reading
     * @throws ExpectedDataObjectNotFoundException, which is a ReadFailedException, if no data exists at path
     *
     * @see {@link ReadTransaction#read(LogicalDatastoreType, InstanceIdentifier)}
     */
