...
public class ActionSetTcpSourcePort extends ActionInfo {
    ...
    public ActionSetTcpSourcePort(int portNumber) {
        super(ActionType.set_tcp_source_port, new String[] {Integer.toString(portNumber)});
        this.portNumber = portNumber;
    }

    @Deprecated
    public ActionSetTcpSourcePort(String[] actionValues) {
        super(ActionType.set_tcp_source_port, actionValues);
