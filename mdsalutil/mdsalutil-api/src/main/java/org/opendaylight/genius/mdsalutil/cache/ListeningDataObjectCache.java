 ...
 */
public class ListeningDataObjectCache<V extends DataObject> implements DataObjectCache<V> {
    ...
    public ListeningDataObjectCache(Class<V> dataObjectClass, DataBroker dataBroker, LogicalDatastoreType datastoreType,
