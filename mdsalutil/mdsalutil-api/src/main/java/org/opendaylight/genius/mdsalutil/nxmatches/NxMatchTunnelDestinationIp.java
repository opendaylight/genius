...
public class NxMatchTunnelDestinationIp extends NxMatchInfoHelper<NxmNxTunIpv4Dst, NxmNxTunIpv4DstBuilder> {
    ...
    public NxMatchTunnelDestinationIp(Ipv4Address address) {
        super(NxmNxTunIpv4DstKey.class, NxMatchFieldType.tun_dst_ip, new String[] {address.getValue()});
    ...
    public int compareTo(MatchInfoBase other) {
        return compareTo(other, new Comparator<NxMatchTunnelDestinationIp>() {
            @Override
            public int compare(NxMatchTunnelDestinationIp left, NxMatchTunnelDestinationIp right) {
