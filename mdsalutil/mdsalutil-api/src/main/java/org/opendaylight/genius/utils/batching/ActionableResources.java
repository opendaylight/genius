...
public final class ActionableResources {
    ...
    public static <T extends DataObject> @NonNull ActionableResource create(Identifier identifier,
    ...
    public static <T extends DataObject> @NonNull ActionableResource update(Identifier identifier,
            InstanceIdentifier<T> path, T newData, T oldData) {
        return new ActionableResourceImpl(identifier, path, ActionableResource.UPDATE, requireNonNull(newData), oldData);
    }
    ...
    public static <T extends DataObject> @NonNull ActionableResource delete(Identifier identifier,
            InstanceIdentifier<T> path, T data) {
