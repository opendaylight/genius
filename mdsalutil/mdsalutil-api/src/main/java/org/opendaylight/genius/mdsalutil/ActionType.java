    ...
    set_udp_destination_port {
        ...
        public Action buildAction(int newActionKey, ActionInfo actionInfo) {
            if (actionInfo instanceof ActionSetUdpDestinationPort) {
                ...
                return new ActionSetUdpDestinationPort(actionInfo.getActionValues()).buildAction(newActionKey);
            }
        }
    },
    ...
    set_udp_source_port {
        ...
        public Action buildAction(int newActionKey, ActionInfo actionInfo) {
            if (actionInfo instanceof ActionSetUdpSourcePort) {
                ...
                return new ActionSetUdpSourcePort(actionInfo.getActionValues()).buildAction(newActionKey);
            }
        }
    },
    ...
    set_tcp_destination_port {
        ...
        public Action buildAction(int newActionKey, ActionInfo actionInfo) {
            if (actionInfo instanceof ActionSetTcpDestinationPort) {
                ...
                return new ActionSetTcpDestinationPort(actionInfo.getActionValues()).buildAction(newActionKey);
            }
        }
    },
    ...
    set_tcp_source_port {
        ...
        public Action buildAction(int newActionKey, ActionInfo actionInfo) {
            if (actionInfo instanceof ActionSetTcpSourcePort) {
                ...
                return new ActionSetTcpSourcePort(actionInfo.getActionValues()).buildAction(newActionKey);
            }
        }
    },
