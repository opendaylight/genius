...
public enum ActionType {
    ...
    load_mac_to_sha {
         ...
         * (non-Javadoc)
         * 
         * @see org.opendaylight.genius.mdsalutil.ActionType#buildAction(int,
         * org.opendaylight.genius.mdsalutil.ActionInfo)
         */
        @Override
        public Action buildAction(int newActionKey, ActionInfo actionInfo) {

            if (actionInfo == null || actionInfo.getActionValues() == null
                    || actionInfo.getActionValues().length == 0) {
            ...
            return new ActionBuilder().setKey(new ActionKey(newActionKey))
                    .setAction(nxLoadArpShaAction(
                            BigInteger.valueOf(NWUtil.macToLong(mac))))
                    .build();
        }

        private org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action nxLoadArpShaAction(
                BigInteger value) {
    ...
    load_ip_to_spa {
        ...
        /* (non-Javadoc)
         * @see org.opendaylight.genius.mdsalutil.ActionType#buildAction(int, org.opendaylight.genius.mdsalutil.ActionInfo)
         */
        @Override
        public Action buildAction(int newActionKey, ActionInfo actionInfo) {
            ...
            return new ActionBuilder().setKey(new ActionKey(newActionKey))
                    .setAction(nxLoadArpSpaAction(ipAddress)).build();

        }

        private org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action nxLoadArpSpaAction(
                BigInteger value) {
        ...
        private org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action nxLoadArpSpaAction(
            ...
            final int ip = InetAddresses
                    .coerceToInteger(InetAddresses.forString(ipAddress));
            final long ipl = ip & 0xffffffffL;
