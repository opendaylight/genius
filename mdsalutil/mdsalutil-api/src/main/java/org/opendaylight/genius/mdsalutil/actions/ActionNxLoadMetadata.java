...
public class ActionNxLoadMetadata extends ActionInfo {
    ...
    public ActionNxLoadMetadata(BigInteger value, Integer startBit, int endBit) {
        this(0, value, startBit, endBit);
    }

    public ActionNxLoadMetadata(int actionKey, BigInteger value,int startBit, int endBit) {
        super(actionKey);
        this.value = value;
