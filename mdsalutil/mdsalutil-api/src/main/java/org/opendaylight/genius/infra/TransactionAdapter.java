...
public final class TransactionAdapter {
    ...
    public static ReadWriteTransaction toReadWriteTransaction(
        ...
        if (datastoreTx instanceof NonSubmitCancelableDatastoreReadWriteTransaction) {
            NonSubmitCancelableDatastoreReadWriteTransaction nonSubmitCancelableDatastoreReadWriteTransaction =
                    (NonSubmitCancelableDatastoreReadWriteTransaction) datastoreTx;
    ...
    public static WriteTransaction toWriteTransaction(DatastoreWriteTransaction<? extends Datastore> datastoreTx) {
        if (datastoreTx instanceof NonSubmitCancelableDatastoreWriteTransaction) {
            NonSubmitCancelableDatastoreWriteTransaction nonSubmitCancelableDatastoreWriteTransaction =
                    (NonSubmitCancelableDatastoreWriteTransaction) datastoreTx;
    ...
    private static class ReadWriteTransactionAdapter extends WriteTransactionAdapter implements ReadWriteTransaction {
