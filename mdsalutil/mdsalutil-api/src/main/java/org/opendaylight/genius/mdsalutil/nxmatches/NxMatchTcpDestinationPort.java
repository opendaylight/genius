...
public class NxMatchTcpDestinationPort extends NxMatchInfoHelper<NxmOfTcpDst, NxmOfTcpDstBuilder> {
    ...
    public NxMatchTcpDestinationPort(int port, int mask) {
        super(NxMatchFieldType.nx_tcp_dst_with_mask, new long[] {port, mask});
        this.port = port;
        this.mask = mask;
    }

    @Override
    protected void applyValue(MatchBuilder matchBuilder, NxmOfTcpDst value) {
        NxAugMatchNodesNodeTableFlow nxAugMatch = new NxAugMatchNodesNodeTableFlowBuilder()
                .setNxmOfTcpDst(value).build();
    ...
    public boolean equals(Object o) {
        ...
        NxMatchTcpDestinationPort that = (NxMatchTcpDestinationPort) o;
