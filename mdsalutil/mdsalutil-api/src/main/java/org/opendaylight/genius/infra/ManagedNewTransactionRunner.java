...
/**
 * Managed transactions utility to simplifies handling of new transactions and ensure transactions are always closed.
 *
...
public interface ManagedNewTransactionRunner {
     ...
     *
     * <p>This is obviously an asynchronous API, like {@link DataBroker}'s own;
     * when returning from this method, the operation of the Transaction may well still be ongoing in the background;
     * calling code therefore <b>must</b> handle the returned future, e.g. by passinng it onwards (return),
    ...
    // TODO void callWithNewReadOnlyTransactionAndSubmit(CheckedConsumer<ReadOnlyTransaction> txRunner);
