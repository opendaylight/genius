...
public class ND extends Packet {
    ...
    private static final String TARGET_ADDR_LEN = "TargetAddressLength";
    private static final String TARGET_L1_ADDR = "TargetL1Address";
    ...
    private static Map<String, Pair<Integer, Integer>> fieldCoordinates
        ...
        //TODO OPTIONS NITHI
        put(OPTION_TYPE, new ImmutablePair<>(624, 8));
        put(TARGET_ADDR_LEN,new ImmutablePair<>(632, 8));
        put(TARGET_L1_ADDR,new ImmutablePair<>(640, 48));
    ...
    public byte getOptionType() {
        return BitBufferHelper.getByte(fieldValues.get(OPTION_TYPE));
    }

    public byte getTargetAddrLen() {
        return BitBufferHelper.getByte(fieldValues.get(TARGET_ADDR_LEN));
    }

    public byte[] getTargetL1Address() { return fieldValues.get(TARGET_L1_ADDR); }
    ...
    public ND setOptionType(byte optionType) {
        byte[] option_Type = BitBufferHelper
                .toByteArray(optionType);
        fieldValues.put(OPTION_TYPE, option_Type);
        return this;
    }

    public ND setTargetAddrLen(byte targetAddrLen) {
        byte[] targetAddressLength = BitBufferHelper
                .toByteArray(targetAddrLen);
        fieldValues.put(TARGET_ADDR_LEN, targetAddressLength);
        return this;
    }

    public ND setTargetL1Address(byte[] targetL1Address) {
        fieldValues.put(TARGET_L1_ADDR, targetL1Address);
        return this;
    }
