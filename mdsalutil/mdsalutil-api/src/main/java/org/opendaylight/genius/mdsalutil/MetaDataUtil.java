...
public class MetaDataUtil {
    ...
    public static final BigInteger METADA_MASK_VALID_TUNNEL_ID_BIT_AND_TUNNEL_ID = new BigInteger("08000000FFFFFF00",
            16);
    ...
    public static int getServiceTagFromMetadata(BigInteger metadata) {
        return (((metadata.and(MetaDataUtil.METADATA_MASK_SERVICE_INDEX)).shiftRight(61))).intValue();
    }
    ...
    /**
     * For the tunnel id with VNI and valid-vni-flag set, the most significant
     * byte should have 08. So, shifting 08 to 7 bytes (56 bits) and the result
     * is OR-ed with VNI being shifted to 1 byte.
     */
