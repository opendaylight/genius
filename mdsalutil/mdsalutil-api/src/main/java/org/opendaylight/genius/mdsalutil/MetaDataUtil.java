...
public class MetaDataUtil {
    ...
    public static int getReg6ValueForLPortDispatcher(int lportTag, short serviceIndex) {
        return getServiceIndexForReg6(serviceIndex).or(getLportTagForReg6(lportTag)).intValue();
    }
