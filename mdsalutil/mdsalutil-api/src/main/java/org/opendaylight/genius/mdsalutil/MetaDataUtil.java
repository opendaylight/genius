...
public final class MetaDataUtil {
    ...
    public static final BigInteger METADATA_MASK_ACL_DROP_TYPE = new BigInteger("0000000000000004", 16);
    ...
    public static BigInteger getDropMetaData(BigInteger dropType) {
        return METADATA_MASK_ACL_DROP_TYPE.and(dropType.shiftLeft(2));
    }
