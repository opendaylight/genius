...
public interface DataTreeEventCallbackRegistrar {
    ...
    <T extends DataObject> void onAdd(LogicalDatastoreType type, InstanceIdentifier<T> dataTreeIdentifier,
            Function<T, UnregisterOrCallAgain> callback);

    <T extends DataObject> void onUpdate(LogicalDatastoreType type, InstanceIdentifier<T> dataTreeIdentifier,
            BiFunction<T, T, UnregisterOrCallAgain> callback);

    <T extends DataObject> void onRemove(LogicalDatastoreType type, InstanceIdentifier<T> dataTreeIdentifier,
            Function<T, UnregisterOrCallAgain> callback);
