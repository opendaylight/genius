...
public interface DataTreeEventCallbackRegistrar {
    ...
    // TODO add timing out variants for onUpdate(), onAddOrUpdate() and onRemove()
    ...
    // NB: There is, for the moment, intentionally no variant with a timeout and a NextAction.
