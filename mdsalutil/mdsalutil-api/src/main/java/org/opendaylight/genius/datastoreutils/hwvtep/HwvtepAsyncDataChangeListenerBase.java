...
public abstract class HwvtepAsyncDataChangeListenerBase<T extends DataObject, K extends DataChangeListener> extends AsyncDataChangeListenerBase<T,K> {


    public HwvtepAsyncDataChangeListenerBase(Class clazz, Class eventClazz) {
    ...
    protected void remove(InstanceIdentifier<T> identifier, T del) {
        ...
        if (HwvtepHACache.isHAEnabledDevice(nodeId)) {
            return;
        }
