...
public enum MatchFieldType {
    ...
    eth_src {
        ...
        private MatchEthernetSource getMatchEthernetSource(MatchInfo matchInfo) {
            return matchInfo instanceof MatchEthernetSource ? (MatchEthernetSource) matchInfo : new MatchEthernetSource(
    ...
    eth_dst {
        ...
        private MatchEthernetDestination getMatchEthernetDestination(MatchInfo matchInfo) {
            return matchInfo instanceof MatchEthernetDestination ? (MatchEthernetDestination) matchInfo : new
                    MatchEthernetDestination(new MacAddress(matchInfo.getStringMatchValues()[0]));
        }
    },
