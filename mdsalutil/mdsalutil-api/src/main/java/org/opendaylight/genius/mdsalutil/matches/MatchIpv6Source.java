...
public class MatchIpv6Source extends MatchInfoHelper<Ipv6Match, Ipv6MatchBuilder> {
    ...
    public MatchIpv6Source(String address) {
        super(MatchFieldType.ipv6_source, new String[] {address});
        this.prefix = new Ipv6Prefix(address);
    }

    public MatchIpv6Source(Ipv6Prefix prefix) {
        super(MatchFieldType.ipv6_source, new String[] {prefix.getValue()});
        this.prefix = prefix;
    }
     ...
     */
    @Deprecated
    public MatchIpv6Source(BigInteger[] bigMatchValues, MatchFieldType matchField, long[] matchValues,
