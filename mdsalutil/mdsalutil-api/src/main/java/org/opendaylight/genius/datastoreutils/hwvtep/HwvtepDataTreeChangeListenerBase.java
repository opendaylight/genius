...
public abstract class HwvtepDataTreeChangeListenerBase<T extends DataObject, K extends DataTreeChangeListener>
     ...
     * @param eventClazz
     */
    public HwvtepDataTreeChangeListenerBase(Class clazz, Class eventClazz) {
