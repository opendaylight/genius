 ...
 *
 * @see https://github.com/vorburger/java-sandbox/blob/master/equalshelper/src/test/java/ch/vorburger/equalshelper/Thing.java#L10
 *
 * @see https://github.com/google/guava/issues/2521
 *
