...
public interface ManagedTransactionFactory {
     ...
     */
    <D extends Datastore, E extends Exception, R> R applyWithNewReadTransactionAndClose(Class<D> datastoreType,
     ...
     * @throws InterruptedException if the transaction is interrupted.
     */
    <D extends Datastore, E extends Exception> void callWithNewReadTransactionAndClose(Class<D> datastoreType,
