...
public class ActionSetUdpDestinationPort extends ActionInfo {
    ...
    public ActionSetUdpDestinationPort(int actionKey, int portNumber) {
        super(ActionType.set_udp_destination_port, new String[] {Integer.toString(portNumber)}, actionKey);
