            ...
            for (ActionableResource actResource : actResourceList) {
                ...
                switch (actResource.getAction()) {
                    ...
                    case ActionableResource.UPDATE:
                        ...
                        break;
                    case ActionableResource.UPDATE_CONTAINER:
                        Object updated_container = actResource.getInstance();
                        Object original_container = actResource.getOldInstance();
                        resHandler.updateContainer(tx, dsType, actResource.getInstanceIdentifier(),
                                original_container, updated_container,transactionObjects);
                        break;
