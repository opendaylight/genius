...
public class MatchIpv4Destination extends MatchInfoHelper<Ipv4Match, Ipv4MatchBuilder> {
    ...
    public MatchIpv4Destination(Ipv4Prefix prefix) {
        super(MatchFieldType.ipv4_destination, prefix.getValue().split("/"));
        this.prefix = prefix;
    }

    public MatchIpv4Destination(long ip, long mask) {
        super(MatchFieldType.ipv4_dst, new long[] {ip, mask});
        this.prefix = new Ipv4Prefix(MDSALUtil.longToIp(ip, mask));
    }

    public MatchIpv4Destination(String ip, String mask) {
        super(MatchFieldType.ipv4_destination, new String[] {ip, mask});
     ...
     */
    @Deprecated
    public MatchIpv4Destination(BigInteger[] bigMatchValues, MatchFieldType matchField, long[] matchValues,
