...
public class ActionSetFieldEthernetSource extends ActionInfo {
    ...
    public ActionSetFieldEthernetSource(MacAddress source) {
        super(ActionType.set_field_eth_src, new String[] {source.getValue()});
        this.source = source;
    }

    @Deprecated
    public ActionSetFieldEthernetSource(String[] actionValues) {
        super(ActionType.set_field_eth_src, actionValues);
        this.source = new MacAddress(actionValues[0]);
    }
