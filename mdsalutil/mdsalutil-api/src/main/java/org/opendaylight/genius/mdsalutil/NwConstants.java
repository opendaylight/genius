...
public final class NwConstants {
    ...
    public static final short SFC_TRANSPORT_INGRESS_TABLE = 81;
    public static final short SFC_TRANSPORT_PATH_MAPPER_TABLE = 82;
    public static final short SFC_TRANSPORT_PATH_MAPPER_ACL_TABLE = 85;
    public static final short SFC_TRANSPORT_NEXT_HOP_TABLE = 84;
    public static final short SFC_TRANSPORT_EGRESS_TABLE = 85;
