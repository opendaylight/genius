...
public interface NwConstants {
    ...
    enum NxmOfFieldType {
        ...
        NXM_NX_IP_FRAG_W(0x0001, 26, 1, 8),
        NXM_NX_IPV6_LABEL(0x0001, 27, 4, 20),
        NXM_NX_IP_ECN(0x0001, 28, 1, 2),
        NXM_NX_IP_TTL(0x0001, 29, 1, 8),
        NXM_NX_COOKIE(0x0001, 30, 8, 64),
        NXM_NX_COOKIE_W(0x0001, 30, 8, 64),
