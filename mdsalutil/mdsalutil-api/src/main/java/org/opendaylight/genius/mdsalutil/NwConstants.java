...
public class NwConstants {
    ...
    public static final short ELAN_KNOWN_DMAC_TABLE = 51;
    public static final short ELAN_UNKNOWN_DMAC_TABLE = 52;
    public static final short ELAN_FAMILY_SMAC_TABLE = 55;
    public static final short ELAN_FAMILY_KNOWN_DMAC_TABLE = 56;
    public static final short ELAN_FAMILY_UNKNOWN_DMAC_TABLE = 57;
