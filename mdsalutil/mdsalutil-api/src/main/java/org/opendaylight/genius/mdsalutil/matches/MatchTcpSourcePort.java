...
public class MatchTcpSourcePort extends MatchInfoHelper<TcpMatch, TcpMatchBuilder> {
    ...
    public MatchTcpSourcePort(int port) {
        super(MatchFieldType.tcp_src, new long[] {port});
        this.port = port;
    }
     ...
     */
    @Deprecated
    public MatchTcpSourcePort(BigInteger[] bigMatchValues, MatchFieldType matchField, long[] matchValues, int port,
    ...
    protected void populateBuilder(TcpMatchBuilder builder) {
        builder.setTcpSourcePort(new PortNumber(port));
    }
