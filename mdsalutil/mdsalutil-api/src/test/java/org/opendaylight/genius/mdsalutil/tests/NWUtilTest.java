...
public class NWUtilTest {
    ...
    public void testIsIpAddressInRange() {
        // Validate for IPv4
        boolean result = NWUtil.isIpAddressInRange(buildIpAddress("1.1.1.1"), buildIpPrefix("1.1.1.0/24"));
        assertTrue(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("10.0.0.10"), buildIpPrefix("10.0.0.0/24"));
        assertTrue(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("20.0.0.20"), buildIpPrefix("20.0.0.0/24"));
        assertTrue(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("20.0.1.20"), buildIpPrefix("20.0.0.0/8"));
        assertTrue(result);

        // Negative cases
        result = NWUtil.isIpAddressInRange(buildIpAddress("10.0.1.10"), buildIpPrefix("10.0.0.0/24"));
        assertFalse(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("10.0.0.10"), buildIpPrefix("20.0.0.0/24"));
        assertFalse(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("10.0.0.10"), buildIpPrefix("1001:db8:0:2::/64"));
        assertFalse(result);

        // Validate for IPv6
        result = NWUtil.isIpAddressInRange(buildIpAddress("1001:db8:0:2:f816:3eff:fe5e:7e1"),
                buildIpPrefix("1001:db8:0:2::/64"));
        assertTrue(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("2001:db8:0:2:f816:3eff:fe5e:1111"),
                buildIpPrefix("2001:db8:0:2::/64"));
        assertTrue(result);

        // Negative cases
        result = NWUtil.isIpAddressInRange(buildIpAddress("2001:db8:0:3:f816:3eff:fe5e:1111"),
                buildIpPrefix("2001:db8:0:2::/64"));
        assertFalse(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("1001:db8:0:2:f816:3eff:fe5e:1111"),
                buildIpPrefix("2001:db8:0:2::/64"));
        assertFalse(result);
        result = NWUtil.isIpAddressInRange(buildIpAddress("1001:db8:0:2:f816:3eff:fe5e:1111"),
