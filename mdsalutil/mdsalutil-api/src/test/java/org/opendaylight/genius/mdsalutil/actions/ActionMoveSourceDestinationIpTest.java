...
public class ActionMoveSourceDestinationIpTest {
    ...
    public void backwardsCompatibleAction() {
        verifyAction(new ActionInfo(ActionType.move_src_dst_ip, new String[0]).buildAction());
    }
    ...
    public void generateAction() {
        ...
        assertEquals("new ActionMoveSourceDestinationIp" + System.lineSeparator(), generator.getExpression(actionInfo));
    }
}
